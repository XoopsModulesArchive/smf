...
function RegCenter()
{
    ...
    if (isset($_REQUEST['sa']) && 'browse' == $_REQUEST['sa']) {
        redirectexit('action=viewmembers;sa=browse' . (isset($_REQUEST['type']) ? ';type=' . $_REQUEST['type'] : ''));
    }

    $subActions = [
        'register' => ['AdminRegister', 'moderate_forum'],
        'agreement' => ['EditAgreement', 'admin_forum'],
        'reservednames' => ['SetReserve', 'admin_forum'],
        'settings' => ['AdminSettings', 'admin_forum'],
    ];
    ...
    $context['admin_tabs'] = [
        ...
        'tabs' => [
            'register' => [
                ...
                'is_selected' => 'register' == $context['sub_action'],
    ...
    if (allowedTo('admin_forum')) {
        $context['admin_tabs']['tabs']['agreement'] = [
            'title' => $txt['smf11'],
            'description' => $txt['smf12'],
            'href' => $scripturl . '?action=regcenter;sa=agreement',
            'is_selected' => 'agreement' == $context['sub_action'],
        ];

        $context['admin_tabs']['tabs']['reservednames'] = [
            'title' => $txt[341],
            'description' => $txt[699],
            'href' => $scripturl . '?action=regcenter;sa=reservednames',
            'is_selected' => 'reservednames' == $context['sub_action'],
        ];
        ...
        $context['admin_tabs']['tabs']['settings'] = [
            ...
            'is_last' => true,
            'is_selected' => 'settings' == $context['sub_action'],
        ];
    }
...
function EditAgreement()
{
    ...
    if (isset($_POST['agreement'])) {
        ...
        updateSettings(['requireAgreement' => !empty($_POST['requireAgreement'])]);
    ...
    $context['agreement'] = file_exists($boarddir . '/agreement.txt') ? htmlspecialchars(file_get_contents($boarddir . '/agreement.txt'), ENT_QUOTES | ENT_HTML5) : '';
...
function SetReserve()
{
    ...
    $context['reserved_word_options']['match_word'] = '1' == $modSettings['reserveWord'];

    $context['reserved_word_options']['match_case'] = '1' == $modSettings['reserveCase'];

    $context['reserved_word_options']['match_user'] = '1' == $modSettings['reserveUser'];

    $context['reserved_word_options']['match_name'] = '1' == $modSettings['reserveName'];
