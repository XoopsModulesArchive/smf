...
function ModifyHolidays()
{
    ...
    [$context['holidayCount']] = $GLOBALS['xoopsDB']->fetchRow($request);
    ...
    while (false !== ($row = $GLOBALS['xoopsDB']->fetchArray($request))) {
        $context['holidays'][] = [
            'id' => $row['ID_HOLIDAY'],
            'date' => $row['day'] . ' ' . $txt['months'][$row['month']] . ' ' . ('0004' == $row['year'] ? '(' . $txt['every_year'] . ')' : $row['year']),
            'title' => $row['title'],
        ];
    }
...
function EditHoliday()
{
    ...
    $context['holiday']['last_day'] = (int)strftime('%d', mktime(0, 0, 0, 12 == $context['holiday']['month'] ? 1 : $context['holiday']['month'] + 1, 0, 12 == $context['holiday']['month'] ? $context['holiday']['year'] + 1 : $context['holiday']['year']));
}
...
function ModifySettings()
{
    ...
    if (isset($_POST['sc'], $_POST['cal_days_for_index'])) {
        ...
        $toSet['cal_showholidaysonindex'] = 'index' == $_POST['cal_showholidays'] || 'all' == $_POST['cal_showholidays'] ? '1' : '0';

        $toSet['cal_showbdaysonindex'] = 'index' == $_POST['cal_showbdays'] || 'all' == $_POST['cal_showbdays'] ? '1' : '0';

        $toSet['cal_showeventsonindex'] = 'index' == $_POST['cal_showevents'] || 'all' == $_POST['cal_showevents'] ? '1' : '0';

        $toSet['cal_showholidaysoncalendar'] = 'cal' == $_POST['cal_showholidays'] || 'all' == $_POST['cal_showholidays'] ? '1' : '0';

        $toSet['cal_showbdaysoncalendar'] = 'cal' == $_POST['cal_showbdays'] || 'all' == $_POST['cal_showbdays'] ? '1' : '0';

        $toSet['cal_showeventsoncalendar'] = 'cal' == $_POST['cal_showevents'] || 'all' == $_POST['cal_showevents'] ? '1' : '0';
