...
function template_main()
{
    ...
    if (!empty($context['members'])) {
		...
		<tr style="text-align: center;"', empty($member['sort_letter']) ? '' : ' id="letter' . $member['sort_letter'] . '"', '>
			<td class="windowbg2">
				', $context['can_send_pm'] ? '<a href="' . $member['online']['href'] . '" title="' . $member['online']['text'] . '">' : '', $settings['use_image_buttons'] ? '<img src="'
                                                                                                                                                                             . $member['online']['image_href']
                                                                                                                                                                             . '" alt="'
                                                                                                                                                                             . $member['online']['text']
                                                                                                                                                                             . '" align="middle">' : $member['online']['label'], $context['can_send_pm'] ? '</a>' : '', '
			</td>
    ...
    echo '
		...
		<div class="windowbg" align="center" style="padding-bottom: 1ex;">
			<table width="440" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td align="left">
								<label for="fields-email"><input type="checkbox" name="fields[]" id="fields-email" value="email" checked class="check"> ', $txt['mlist_search_email'], '</label><br>
					...
					<td align="left" valign="top">
								<label for="fields-name"><input type="checkbox" name="fields[]" id="fields-name" value="name" checked class="check"> ', $txt['mlist_search_name'], '</label><br>
