...
function template_folder()
{
    ...
    echo '
<form action="', $scripturl, '?action=pm;sa=pmactions;f=', $context['folder'], ';start=', $context['start'], -1 != $context['current_label_id'] ? ';l=' . $context['current_label_id'] : '', '" method="post" accept-charset="', $context['character_set'], '" name="pmFolder">
	<table border="0" width="100%" cellpadding="2" cellspacing="1" class="bordercolor">
		<tr class="titlebg">
			<td align="center" width="2%">&nbsp;</td>
			<td style="width: 32ex;"><a href="', $scripturl, '?action=pm;f=', $context['folder'], ';start=', $context['start'], ';sort=date', 'date' == $context['sort_by'] && 'up' == $context['sort_direction'] ? ';desc' : '', ';', -1 != $context['current_label_id'] ? ';l='
                                                                                                                                                                                                                                                                            . $context['current_label_id'] : '', '">', $txt[317], 'date'
                                                                                                                                                                                                                                                                                                                                  == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                                                                                              . $settings['images_url']
                                                                                                                                                                                                                                                                                                                                              . '/sort_'
                                                                                                                                                                                                                                                                                                                                              . $context['sort_direction']
                                                                                                                                                                                                                                                                                                                                              . '.gif" alt="">' : '', '</a></td>
			<td width="46%"><a href="', $scripturl, '?action=pm;f=', $context['folder'], ';start=', $context['start'], ';sort=subject', 'subject' == $context['sort_by'] && 'up' == $context['sort_direction'] ? ';desc' : '', ';', -1 != $context['current_label_id'] ? ';l='
                                                                                                                                                                                                                                                                         . $context['current_label_id'] : '', '">', $txt[319], 'subject'
                                                                                                                                                                                                                                                                                                                               == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                                                                                              . $settings['images_url']
                                                                                                                                                                                                                                                                                                                                              . '/sort_'
                                                                                                                                                                                                                                                                                                                                              . $context['sort_direction']
                                                                                                                                                                                                                                                                                                                                              . '.gif" alt="">' : '', '</a></td>
			<td><a href="', $scripturl, '?action=pm;f=', $context['folder'], ';start=', $context['start'], ';sort=name', 'name' == $context['sort_by'] && 'up' == $context['sort_direction'] ? ';desc' : '', ';', -1 != $context['current_label_id'] ? ';l='
                                                                                                                                                                                                                                                       . $context['current_label_id'] : '', '">', ('from'
                                                                                                                                                                                                                                                                                                   == $context['from_or_to'] ? $txt[318] : $txt[324]), 'name'
                                                                                                                                                                                                                                                                                                                                       == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                                                                                                   . $settings['images_url']
                                                                                                                                                                                                                                                                                                                                                   . '/sort_'
                                                                                                                                                                                                                                                                                                                                                   . $context['sort_direction']
    ...
    while ($message = $context['get_pmessage']()) {
        echo '
		<tr class="', 0 == $message['alternate'] ? 'windowbg' : 'windowbg2', '">
			<td align="center" width="2%">', $message['is_replied_to'] ? '<img src="' . $settings['images_url'] . '/icons/pm_replied.gif" style="margin-right: 4px;" alt="' . $txt['pm_replied'] . '">' : '<img src="'
                                                                                                                                                                                                            . $settings['images_url']
                                                                                                                                                                                                            . '/icons/pm_read.gif" style="margin-right: 4px;" alt="'
                                                                                                                                                                                                            . $txt['pm_read']
                                                                                                                                                                                                            . '">', '</td>
			<td>', $message['time'], '</td>
			<td><a href="#msg', $message['id'], '">', $message['subject'], '</a></td>
			<td>', ('from' == $context['from_or_to'] ? $message['member']['link'] : (empty($message['recipients']['to']) ? '' : implode(', ', $message['recipients']['to']))), '</td>
			<td align="center"><input type="checkbox" name="pms[]" id="deletelisting', $message['id'], '" value="', $message['id'], '"', $message['is_selected'] ? ' checked' : '', ' onclick="document.getElementById(\'deletedisplay', $message['id'], '\').checked = this.checked;" class="check"></td>
		</tr>';
    ...
    if ($context['show_delete']) {
        if (!empty($context['currently_using_labels']) && 'outbox' != $context['folder']) {
            echo '
    ...
    if ($context['get_pmessage'](true)) {
        ...
        while ($message = $context['get_pmessage']()) {
            $windowcss = 0 == $message['alternate'] ? 'windowbg' : 'windowbg2';
		...
		<tr><td style="padding: 1px 1px 0 1px;">
            ...
            if (!$message['member']['is_guest']) {
                ...
                if ($message['member']['karma']['allow']) {
                    echo '
									<a href="', $scripturl, '?action=modifykarma;sa=applaud;uid=', $message['member']['id'], ';f=', $context['folder'], ';start=', $context['start'], ';', -1 != $context['current_label_id'] ? ';l='
                                                                                                                                                                                                                                . $context['current_label_id'] : '', ';pm=', $message['id'], ';sesc=', $context['session_id'], '">', $modSettings['karmaApplaudLabel'], '</a> <a href="', $scripturl, '?action=modifykarma;sa=smite;uid=', $message['member']['id'], ';f=', $context['folder'], ';start=', $context['start'], ';', -1
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   != $context['current_label_id'] ? ';l='
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           . $context['current_label_id'] : '', ';pm=', $message['id'], ';sesc=', $context['session_id'], '">', $modSettings['karmaSmiteLabel'], '</a><br>';
                }
                ...
                if (!empty($modSettings['onlineEnable']) && !$message['member']['is_guest']) {
                    echo '
									', $context['can_send_pm'] ? '<a href="' . $message['member']['online']['href'] . '" title="' . $message['member']['online']['label'] . '">' : '', $settings['use_image_buttons'] ? '<img src="'
                                                                                                                                                                                                                        . $message['member']['online']['image_href']
                                                                                                                                                                                                                        . '" style="margin-top: 4px;" alt="'
                                                                                                                                                                                                                        . $message['member']['online']['text']
                                                                                                                                                                                                                        . '">' : $message['member']['online']['text'], $context['can_send_pm'] ? '</a>' : '', $settings['use_image_buttons'] ? '<span class="smalltext"> '
                                                                                                                                                                                                                                                                                                                                                 . $message['member']['online']['text']
                                                                                                                                                                                                                                                                                                                                                 . '</span>' : '', '<br><br>';
                }
                ...
                if ($settings['show_profile_buttons']) {
                    ...
                    if ('' != $message['member']['website']['url']) {
                        echo '
									<a href="', $message['member']['website']['url'], '" target="_blank">', ($settings['use_image_buttons'] ? '<img src="'
                                                                                                                                              . $settings['images_url']
                                                                                                                                              . '/www_sm.gif" alt="'
                                                                                                                                              . $txt[515]
                                                                                                                                              . '" title="'
                                                                                                                                              . $message['member']['website']['title']
                                                                                                                                              . '">' : $txt[515]), '</a>';
                    }
                    ...
                    if (!$context['user']['is_guest'] && $context['can_send_pm']) {
                        echo '
									<a href="', $scripturl, '?action=pm;sa=send;u=', $message['member']['id'], '" title="', $message['member']['online']['label'], '">', $settings['use_image_buttons'] ? '<img src="'
                                                                                                                                                                                                          . $settings['images_url']
                                                                                                                                                                                                          . '/im_'
                                                                                                                                                                                                          . ($message['member']['online']['is_online'] ? 'on' : 'off')
                                                                                                                                                                                                          . '.gif" alt="'
            ...
            if ($context['can_send_pm']) {
                ...
                if (!$message['member']['is_guest']) {
                    ...
                    if ($message['number_recipients'] > 1 && (!empty($settings['use_buttons']) || !$settings['use_image_buttons'])) {
                        echo '
										<a href="', $scripturl, '?action=pm;sa=send;f=', $context['folder'], -1 != $context['current_label_id'] ? ';l=' . $context['current_label_id'] : '', ';pmsg=', $message['id'], ';quote;u=all">', $reply_all_button, '</a>', $context['menu_separator'];
                    }

                    echo '
										<a href="', $scripturl, '?action=pm;sa=send;f=', $context['folder'], -1 != $context['current_label_id'] ? ';l=' . $context['current_label_id'] : '', ';pmsg=', $message['id'], ';quote;u=', 'outbox'
                                                                                                                                                                                                                                    == $context['folder'] ? '' : $message['member']['id'], '">', $quote_button, '</a>', $context['menu_separator'], '
										<a href="', $scripturl, '?action=pm;sa=send;f=', $context['folder'], -1 != $context['current_label_id'] ? ';l='
                                                                                                                                                  . $context['current_label_id'] : '', ';pmsg=', $message['id'], ';u=', $message['member']['id'], '">', $reply_button, '</a> ', $context['menu_separator'];
                } // This is for "forwarding" - even if the member is gone.

                else {
                    echo '
										<a href="', $scripturl, '?action=pm;sa=send;f=', $context['folder'], -1 != $context['current_label_id'] ? ';l=' . $context['current_label_id'] : '', ';pmsg=', $message['id'], ';quote">', $forward_button, '</a>', $context['menu_separator'];
                }
            }

            echo '
										<a href="', $scripturl, '?action=pm;sa=pmactions;pm_actions[', $message['id'], ']=delete;f=', $context['folder'], ';start=', $context['start'], ';', -1 != $context['current_label_id'] ? ';l='
                                                                                                                                                                                                                                  . $context['current_label_id'] : '', ';sesc=', $context['session_id'], '" onclick="return confirm(\'', addslashes(
                                                                                                                                                                                                                                      $txt[154]
                                                                                                                                                                                                                                  ), '?\');">', $delete_button, '</a>
						...
						<tr class="', $windowcss, '">
							<td valign="bottom" class="smalltext" width="85%">
								', (!empty($modSettings['enableReportPM']) && 'outbox' != $context['folder'] ? '<div align="right"><a href="'
                                                                                                               . $scripturl
                                                                                                               . '?action=pm;sa=report;l='
            ...
            if ('outbox' != $context['folder'] && !empty($context['currently_using_labels'])) {
                echo '
						<tr class="', $windowcss, '">
    ...
    if ($context['simple_search']) {
        ...
        echo '
					...
					<table cellpadding="1" cellspacing="3" border="0">
						<tr>
							...
							<td colspan="2">
								<label for="show_complete"><input type="checkbox" name="show_complete" id="show_complete" value="1"', !empty($context['search_params']['show_complete']) ? ' checked' : '', ' class="check"> ', $txt['pm_search_show_complete'], '</label><br>
								<label for="subject_only"><input type="checkbox" name="subject_only" id="subject_only" value="1"', !empty($context['search_params']['subject_only']) ? ' checked' : '', ' class="check"> ', $txt['pm_search_subject_only'], '</label>
							</td>
							<td>
        ...
        if ($context['currently_using_labels']) {
            ...
            foreach ($context['search_labels'] as $label) {
                ...
                echo '
							<td width="50%">
								<label for="searchlabel_', $label['id'], '"><input type="checkbox" id="searchlabel_', $label['id'], '" name="searchlabel[', $label['id'], ']" value="', $label['id'], '" ', $label['checked'] ? 'checked' : '', ' class="check">
								', $label['name'], '</label>
							</td>';
            ...
            echo '
					...
					<br>
					<input type="checkbox" name="all" id="check_all" value="" ', $context['check_all'] ? 'checked' : '', ' onclick="invertAll(this, this.form, \'searchlabel\');" class="check"><i> <label for="check_all">', $txt[737], '</label></i><br>
							</td>
						</tr>';
        }
            ...
            if ($context['can_send_pm']) {
                ...
                if (!$message['member']['is_guest']) {
                    echo '
							<a href="', $scripturl, '?action=pm;sa=send;f=', $context['folder'], -1 != $context['current_label_id'] ? ';l=' . $context['current_label_id'] : '', ';pmsg=', $message['id'], ';quote;u=', 'outbox'
                                                                                                                                                                                                                        == $context['folder'] ? '' : $message['member']['id'], '">', $quote_button, '</a>', $context['menu_separator'], '
							<a href="', $scripturl, '?action=pm;sa=send;f=', $context['folder'], -1 != $context['current_label_id'] ? ';l=' . $context['current_label_id'] : '', ';pmsg=', $message['id'], ';u=', $message['member']['id'], '">', $reply_button, '</a> ', $context['menu_separator'];
                } // This is for "forwarding" - even if the member is gone.

                else {
                    echo '
							<a href="', $scripturl, '?action=pm;sa=send;f=', $context['folder'], -1 != $context['current_label_id'] ? ';l=' . $context['current_label_id'] : '', ';pmsg=', $message['id'], ';quote">', $quote_button, '</a>', $context['menu_separator'];
                }
            }
...
function template_send()
{
    ...
    echo '
							...
							<tr>
								<td></td>
								<td align="left">
									<label for="outbox"><input type="checkbox" name="outbox" id="outbox" value="1" tabindex="', $context['tabindex']++, '"', $context['copy_to_outbox'] ? ' checked' : '', ' class="check"> ', $txt['pm_save_outbox'], '</label>
								</td>
							</tr>
						</table>
						<input type="hidden" name="sc" value="', $context['session_id'], '">
		...
		<script language="JavaScript" type="text/javascript"><!-- // --><![CDATA[
			function autocompleter(element)
			{
				...
				this.handler = function (force)
				{
					...
					var response = this.request.responseText.preg_split("\n");
		...
		<table border="0" width="80%" cellpadding="4" cellspacing="1" class="bordercolor" align="center">
			...
			<tr>
				<td class="windowbg">
					', $txt[413], '<br>
					<br>
					<b><a href="', $scripturl, '?action=pm;sa=removeall2;f=', $context['folder'], ';', -1 != $context['current_label_id'] ? ';l=' . $context['current_label_id'] : '', ';sesc=', $context['session_id'], '">', $txt[163], '</a> - <a href="javascript:history.go(-1);">', $txt[164], '</a></b>
				</td>
			</tr>
		</table>';
}
