    ...
    if (!empty($context['admin_tabs'])) {
        ...
        if (!empty($settings['use_tabs'])) {
            ...
            echo '
					...
					<tr class="windowbg">
						<td class="smalltext" style="padding: 2ex;">', $selected_tab['description'] ?? $context['admin_tabs']['description'], '</td>
					</tr>
				</table>';
        }
    }
...
function template_edit_censored()
{
    ...
    echo '
								...
								<td align="left"><input type="checkbox" name="censorWholeWord" value="1" id="censorWholeWord_check"', empty($modSettings['censorWholeWord']) ? '' : ' checked', ' class="check"></td>
							</tr><tr>
								<th align="right"><label for="censorIgnoreCase_check">', $txt['censor_case'], ':</label></th>
								<td align="left">
									<input type="checkbox" name="censorIgnoreCase" value="1" id="censorIgnoreCase_check"', empty($modSettings['censorIgnoreCase']) ? '' : ' checked', ' class="check">
								</td>
							</tr><tr>
	...
	<form action="', $scripturl, '?action=postsettings;sa=posts" method="post" accept-charset="', $context['character_set'], '">
		<table border="0" cellspacing="0" cellpadding="4" align="center" width="80%" class="tborder">
			<tr class="titlebg">
				...
				<td>
					<input type="checkbox" name="removeNestedQuotes" id="removeNestedQuotes_check"', empty($modSettings['removeNestedQuotes']) ? '' : ' checked', ' class="check">
				</td>
			</tr><tr class="windowbg2">
				...
				<td valign="top">
					<input type="checkbox" name="enableEmbeddedFlash" id="enableEmbeddedFlash_check"', empty($modSettings['enableEmbeddedFlash']) ? '' : ' checked', ' class="check">
				</td>
			</tr><tr class="windowbg2">
				<th width="50%" align="right">
				...
				<td valign="top">
					<input type="checkbox" name="enableSpellChecking" id="enableSpellChecking_check"', empty($modSettings['enableSpellChecking']) ? '' : ' checked', ' class="check">
				</td>
			</tr><tr class="windowbg2">
				<td colspan="2"><hr></td>
			</tr><tr class="windowbg2">
...
function template_edit_bbc_settings()
{
	...
	<form action="', $scripturl, '?action=postsettings;sa=bbc" method="post" accept-charset="', $context['character_set'], '" name="bbcForm" id="bbcForm" onsubmit="toggleBBCDisabled(false);">
		<table border="0" cellspacing="0" cellpadding="4" align="center" width="80%" class="tborder">
			<tr class="titlebg">
				...
				<td>
					<input type="checkbox" name="enableBBC" id="enableBBC_check"', empty($modSettings['enableBBC']) ? '' : ' checked', ' onchange="toggleBBCDisabled(!this.checked);" class="check">
				</td>
			</tr><tr class="windowbg2">
				...
				<td>
					<input type="checkbox" name="enablePostHTML" id="enablePostHTML_check"', empty($modSettings['enablePostHTML']) ? '' : ' checked', ' class="check">
				</td>
			</tr><tr class="windowbg2">
				<th width="50%" align="right"><label for="autoLinkUrls_check">', $txt['autoLinkUrls'], '</label>:</th>
				<td>
					<input type="checkbox" name="autoLinkUrls" id="autoLinkUrls_check"', empty($modSettings['autoLinkUrls']) ? '' : ' checked', ' class="check">
				</td>
			</tr><tr class="windowbg2">
    ...
    foreach ($context['bbc_columns'] as $bbcColumn) {
        ...
        foreach ($bbcColumn as $bbcTag) {
            echo '
								<input type="checkbox" name="enabledTags[]" id="tag_', $bbcTag['tag'], '" value="', $bbcTag['tag'], '"', $bbcTag['is_enabled'] ? ' checked' : '', ' class="check"> <label for="tag_', $bbcTag['tag'], '">', $bbcTag['tag'], '</label>', $bbcTag['show_help'] ? ' (<a href="'
                                                                                                                                                                                                                                                                                                           . $scripturl
                                                                                                                                                                                                                                                                                                           . '?action=helpadmin;help=tag_'
                                                                                                                                                                                                                                                                                                           . $bbcTag['tag']
                                                                                                                                                                                                                                                                                                           . '" onclick="return reqWin(this.href);">?</a>)' : '', '<br>';
        }
    ...
    echo '
						...
						<input type="checkbox" id="select_all" onclick="invertAll(this, this.form, \'enabledTags\');"', $context['bbc_all_selected'] ? ' checked' : '', ' class="check"> <label for="select_all"><i>', $txt['bbcTagsToUse_select_all'], '</i></label>
					</fieldset>
				</td>
			</tr><tr class="windowbg2">
				<td align="right" colspan="2">
	...
	<form action="', $scripturl, '?action=postsettings;sa=topics" method="post" accept-charset="', $context['character_set'], '">
		<table border="0" cellspacing="0" cellpadding="4" align="center" width="80%" class="tborder">
			<tr class="titlebg">
				...
				<td valign="top">
					<input type="checkbox" name="enableStickyTopics" id="enableStickyTopics_check"', empty($modSettings['enableStickyTopics']) ? '' : ' checked', ' class="check">
				</td>
			</tr><tr class="windowbg2">
				<th width="50%" align="right">
				...
				<td valign="top">
					<input type="checkbox" name="enableParticipation" id="enableParticipation_check"', empty($modSettings['enableParticipation']) ? '' : ' checked', ' class="check">
				</td>
			</tr><tr class="windowbg2">
				<td colspan="2"><hr></td>
			</tr><tr class="windowbg2">
				...
				<td valign="top">
					<input type="checkbox" name="enablePreviousNext" id="enablePreviousNext_check"', empty($modSettings['enablePreviousNext']) ? '' : ' checked', ' class="check">
				</td>
			</tr><tr class="windowbg2">
				<td align="right" colspan="2">
					<input type="submit" name="save_settings" value="', $txt['manageposts_settings_submit'], '">
...
function template_maintain()
{
			...
			<tr>
				<td class="windowbg2" style="padding-bottom: 1ex;">
					<form action="', $scripturl, '" method="get" accept-charset="', $context['character_set'], '" onsubmit="return this.struct.checked || this.data.checked;">
						...
						<label for="data"><input type="checkbox" name="data" id="data" onclick="this.form.submitDump.disabled = !this.form.struct.checked &amp;&amp; !this.form.data.checked;" checked class="check"> ', $txt['maintain_backup_data'], '</label><br>
						<br>
						<label for="compress"><input type="checkbox" name="compress" id="compress" value="gzip" checked class="check"> ', $txt['maintain_backup_gz'], '</label>
    ...
    echo '
					<form action="', $scripturl, '?action=removeoldtopics2" method="post" accept-charset="', $context['character_set'], '" name="rotForm" id="rotForm">
						...
						<div style="padding-left: 3ex;">
							<label for="delete_type_nothing"><input type="radio" name="delete_type" id="delete_type_nothing" value="nothing" class="check" checked> ', $txt['maintain_old_nothing_else'], '</label><br>
    ...
    if (!empty($modSettings['enableStickyTopics'])) {
        echo '
						<div style="padding-left: 3ex; padding-top: 1ex;">
							<label for="delete_old_not_sticky"><input type="checkbox" name="delete_old_not_sticky" id="delete_old_not_sticky" class="check" checked> ', $txt['maintain_old_are_not_stickied'], '</label><br>
						</div>';
    }
    ...
    foreach ($context['categories'] as $category) {
        ...
        foreach ($category['boards'] as $board) {
            echo '
										<label for="boards_', $board['id'], '"><input type="checkbox" name="boards[', $board['id'], ']" id="boards_', $board['id'], '" checked class="check"> ', str_repeat('&nbsp; ', $board['child_level']), $board['name'], '</label><br>';
        }
...
function template_optimize()
{
    ...
    echo '
			<br>', 0 == $context['num_tables_optimized'] ? $txt['smf285'] : $context['num_tables_optimized'] . ' ' . $txt['smf286'];
...
function template_show_settings()
{
    ...
    foreach ($context['config_vars'] as $config_var) {
        ...
        if (is_array($config_var)) {
            ...
            echo '
						<td valign="top" ', ($config_var['disabled'] ? ' style="color: #777777;"' : ''), '><label for="', $config_var['name'], '">', $config_var['label'], ('password' == $config_var['type'] ? '<br><i>' . $txt['admin_confirm_password'] . '</i>' : ''), '</label></td>
						<td class="windowbg2" width="50%">';

            // Show a check box.

            if ('check' == $config_var['type']) {
                echo '
							<input type="hidden" name="', $config_var['name'], '" value="0"><input type="checkbox"', ($config_var['disabled'] ? ' disabled="disabled"' : ''), ' name="', $config_var['name'], '" id="', $config_var['name'], '" ', ($config_var['value'] ? ' checked' : ''), ' class="check">';
            } // Escape (via htmlspecialchars.) the text box.

            elseif ('password' == $config_var['type']) {
                echo '
							<input type="password"', ($config_var['disabled'] ? ' disabled="disabled"' : ''), ' name="', $config_var['name'], '[0]"', ($config_var['size'] ? ' size="'
                                                                                                                                                                             . $config_var['size']
                                                                                                                                                                             . '"' : ''), ' value="*#fakepass#*" onfocus="this.value = \'\'; this.form.', $config_var['name'], '.disabled = false;"><br>
							<input type="password" disabled="disabled" id="', $config_var['name'], '" name="', $config_var['name'], '[1]"', ($config_var['size'] ? ' size="' . $config_var['size'] . '"' : ''), '>';
            } // Show a selection box.

            elseif ('select' == $config_var['type']) {
                echo '
            ...
            elseif ('large_text' == $config_var['type']) {
                echo '
							<textarea rows="', ($config_var['size'] ?: 4), '" cols="30" ', ($config_var['disabled'] ? ' disabled="disabled"' : ''), ' name="', $config_var['name'], '">', $config_var['value'], '</textarea>';
