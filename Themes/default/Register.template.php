...
function template_admin_register()
{
    ...
    echo '
				...
				<td width="50%" align="left">
					<input type="checkbox" name="emailPassword" id="emailPassword_check" checked', !empty($modSettings['registration_method']) && 1 == $modSettings['registration_method'] ? ' disabled="disabled"' : '', ' class="check"><br>
				</td>
			</tr><tr class="windowbg2">
				<th width="50%" align="right">
				...
				<td width="50%" align="left">
					<input type="checkbox" name="emailActivate" id="emailActivate_check"', !empty($modSettings['registration_method']) && 1 == $modSettings['registration_method'] ? ' checked' : '', ' onclick="onCheckChange();" class="check"><br>
				</td>
			</tr><tr class="windowbg2">
...
function template_edit_agreement()
{
    ...
    echo '
					...
					<label for="requireAgreement"><input type="checkbox" name="requireAgreement" id="requireAgreement"', $context['require_agreement'] ? ' checked' : '', ' value="1"> ', $txt[584], '.</label><br>
					<br>
					...
					<td class="windowbg2" align="center">
						<div style="width: 80%;">
							...
							<div align="left" style="margin-top: 2ex;">
								<label for="matchword"><input type="checkbox" name="matchword" id="matchword" ', $context['reserved_word_options']['match_word'] ? 'checked' : '', ' class="check"> ', $txt[726], '</label><br>
								<label for="matchcase"><input type="checkbox" name="matchcase" id="matchcase" ', $context['reserved_word_options']['match_case'] ? 'checked' : '', ' class="check"> ', $txt[727], '</label><br>
								<label for="matchuser"><input type="checkbox" name="matchuser" id="matchuser" ', $context['reserved_word_options']['match_user'] ? 'checked' : '', ' class="check"> ', $txt[728], '</label><br>
								<label for="matchname"><input type="checkbox" name="matchname" id="matchname" ', $context['reserved_word_options']['match_name'] ? 'checked' : '', ' class="check"> ', $txt[729], '</label><br>
							</div>
						...
						<tr class="windowbg2">
							...
							<td width="50%" align="left">
								<select name="registration_method" id="registration_method_select">
									...
									<option value="1"', !empty($modSettings['registration_method']) && 1 == $modSettings['registration_method'] ? ' selected="selected"' : '', '>', $txt['admin_setting_registration_activate'], '</option>
									<option value="2"', !empty($modSettings['registration_method']) && 2 == $modSettings['registration_method'] ? ' selected="selected"' : '', '>', $txt['admin_setting_registration_approval'], '</option>
									<option value="3"', !empty($modSettings['registration_method']) && 3 == $modSettings['registration_method'] ? ' selected="selected"' : '', '>', $txt['admin_setting_registration_disabled'], '</option>
								</select>
							</td>
						</tr>
						<tr class="windowbg2">
							...
							<td width="50%" align="left">
								<input type="checkbox" name="notify_new_registration" id="notify_new_registration_check" ', !empty($modSettings['notify_new_registration']) ? 'checked' : '', ' class="check">
							</td>
						</tr><tr class="windowbg2">
							<th width="50%" align="right">
							...
							<td width="50%" align="left">
								<input type="checkbox" name="send_welcomeEmail" id="send_welcomeEmail_check"', !empty($modSettings['send_welcomeEmail']) ? ' checked' : '', ' class="check">
							</td>
						</tr><tr class="windowbg2">
							<th width="50%" align="right">
							...
							<td width="50%" align="left">
								<select name="password_strength" id="password_strength_select">
									...
									<option value="1"', !empty($modSettings['password_strength']) && 1 == $modSettings['password_strength'] ? ' selected="selected"' : '', '>', $txt['admin_setting_password_strength_medium'], '</option>
									<option value="2"', !empty($modSettings['password_strength']) && 2 == $modSettings['password_strength'] ? ' selected="selected"' : '', '>', $txt['admin_setting_password_strength_high'], '</option>
								</select>
							</td>
							...
							<td width="50%" align="left">
								<select name="visual_verification_type" id="visual_verification_type_select" ', $context['use_graphic_library'] ? 'onchange="refreshImages();"' : '', '>
									<option value="1" ', !empty($modSettings['disable_visual_verification']) && 1 == $modSettings['disable_visual_verification'] ? 'selected="selected"' : '', '>', $txt['admin_setting_image_verification_off'], '</option>
									<option value="2" ', !empty($modSettings['disable_visual_verification']) && 2 == $modSettings['disable_visual_verification'] ? 'selected="selected"' : '', '>', $txt['admin_setting_image_verification_vsimple'], '</option>
									<option value="3" ', !empty($modSettings['disable_visual_verification']) && 3 == $modSettings['disable_visual_verification'] ? 'selected="selected"' : '', '>', $txt['admin_setting_image_verification_simple'], '</option>
									...
									<option value="4" ', !empty($modSettings['disable_visual_verification']) && 4 == $modSettings['disable_visual_verification'] ? 'selected="selected"' : '', '>', $txt['admin_setting_image_verification_high'], '</option>
								</select><br>';
    ...
    echo '
							...
							<td width="50%" align="left">
								<select name="coppaType" id="coppaType_select" onchange="checkCoppa();">
									...
									<option value="1"', !empty($modSettings['coppaType']) && 1 == $modSettings['coppaType'] ? ' selected="selected"' : '', '>', $txt['admin_setting_coppaType_approval'], '</option>
								</select>
							</td>
						</tr><tr class="windowbg2" valign="top">
							<th width="50%" align="right">
