...
function template_extract_package()
{
    ...
    if (!empty($context['redirect_url'])) {
        ...
        if ('avatar' == $context['extract_type']) {
            echo '
					', $txt['package39'];
        } elseif ('language' == $context['extract_type']) {
            echo '
					', $txt['package41'];
        } else {
            echo '
		...
		<div class="tborder">
			...
			<div class="windowbg2" style="padding: 4px;">
				<form action="', $scripturl, '?action=packages;sa=options" method="post" accept-charset="', $context['character_set'], '">
					...
					<label for="package_make_backups"><input type="checkbox" name="package_make_backups" id="package_make_backups" value="1" class="check"', $context['package_make_backups'] ? ' checked' : '', '> ', $txt['package_install_options_make_backups'], '</label><br>
		...
		<div class="tborder" style="margin-top: 2ex;">
			...
			<div class="windowbg2" style="padding: 4px;">
				<form action="', $scripturl, '?action=cleanperms" method="post" accept-charset="', $context['character_set'], '">
					...
					<br>
					<label for="perm_type_standard"><input type="radio" name="perm_type" id="perm_type_standard" value="standard" checked class="check"> ', $txt['package_cleanperms_standard'], '</label><br>
