		...
		<table border="0" width="400" cellspacing="0" cellpadding="3" align="center" class="tborder">
			<tr class="titlebg">
				...
				<td align="center" style="padding-top: 2ex; padding-bottom: 1ex;">
					...
					<br>
					<input type="radio" name="step2" value="onlythis" checked class="check"> ', $txt['smf255'], '<br>
        ...
        echo '
							<tr>
								<td class="windowbg2" valign="middle">
									<input type="checkbox" class="check" name="topics[]" value="' . $topic['id'] . '" checked>
								</td>
								<td class="windowbg2" valign="middle">
								...
								<td class="windowbg2" valign="middle">
									<input type="checkbox" class="check" name="notifications[]" value="' . $topic['id'] . '" checked>
								</td>
							</tr>';
    }
    ...
    if (!empty($context['boards']) && count($context['boards']) > 1) {
        ...
        foreach ($context['boards'] as $board) {
            echo '
						<tr>
							<td>
								<input type="radio" name="board" value="' . $board['id'] . '"' . ($board['selected'] ? ' checked' : '') . ' class="check"> ' . $board['name'] . '
							</td>
						</tr>';
        }
