...
function template_email_members()
{
    ...
    echo '
						<br>
						<label for="checkAllGroups"><input type="checkbox" id="checkAllGroups" checked onclick="invertAll(this, this.form, \'who\');" class="check"> <i>', $txt[737], '</i></label><br>
			...
			<table width="600" cellpadding="5" cellspacing="0" border="0" align="center" class="tborder">
				<tr class="titlebg">
					...
					<td class="windowbg2">
						...
						<label for="parse_html"><input type="checkbox" name="parse_html" id="parse_html" checked disabled="disabled" class="check"> ', $txt['email_parsed_html'], '</label><br>
						<br>
...
function template_news_settings()
{
    ...
    echo '
			<tr class="windowbg2">
				...
				<td>
					<input type="checkbox" name="xmlnews_enable" id="xmlnews_enable_check"', empty($modSettings['xmlnews_enable']) ? '' : ' checked', ' class="check" onclick="document.getElementById(\'xmlnews_maxlen_input\').disabled = !this.checked;">
				</td>
			</tr><tr class="windowbg2">
