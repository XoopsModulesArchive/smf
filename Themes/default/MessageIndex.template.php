...
function template_main()
{
    ...
    if (isset($context['boards']) && (!empty($options['show_children']) || 0 == $context['start'])) {
        echo '
	<div class="tborder" style="margin-bottom: 3ex; ', $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? ' width: 100%;' : '', '">
        ...
        foreach ($context['boards'] as $board) {
            ...
            if (!empty($board['moderators'])) {
                echo '
					<div style="padding-top: 1px;"><small><i>', 1 == count($board['moderators']) ? $txt[298] : $txt[299], ': ', implode(', ', $board['link_moderators']), '</i></small></div>';
            }
    ...
    $normal_buttons = [
        'markread' => ['text' => 'mark_read_short', 'image' => 'markread.gif', 'lang' => true, 'url' => $scripturl . '?action=markasread;sa=board;board=' . $context['current_board'] . '.0;sesc=' . $context['session_id']],
        'notify' => [
            ...
            'url' => $scripturl . '?action=notifyboard;sa=' . ($context['is_marked_notify'] ? 'off' : 'on') . ';board=' . $context['current_board'] . '.' . $context['start'] . ';sesc=' . $context['session_id'],
        ],
        'new_topic' => ['test' => 'can_post_new', 'text' => 'smf258', 'image' => 'new_topic.gif', 'lang' => true, 'url' => $scripturl . '?action=post;board=' . $context['current_board'] . '.0'],
        'post_poll' => ['test' => 'can_post_poll', 'text' => 'smf20', 'image' => 'new_poll.gif', 'lang' => true, 'url' => $scripturl . '?action=post;board=' . $context['current_board'] . '.0;poll'],
    ];
	...
	<form action="', $scripturl, '?action=quickmod;board=', $context['current_board'], '.', $context['start'], '" method="post" accept-charset="', $context['character_set'], '" name="quickModForm" id="quickModForm" style="margin: 0;">';
        ...
        if (!empty($context['topics'])) {
            echo '
						...
						<td class="catbg3"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=subject', 'subject' == $context['sort_by'] && 'up' == $context['sort_direction'] ? ';desc' : '', '">', $txt[70], 'subject' == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                                            . $settings['images_url']
                                                                                                                                                                                                                                                                                            . '/sort_'
                                                                                                                                                                                                                                                                                            . $context['sort_direction']
                                                                                                                                                                                                                                                                                            . '.gif" alt="">' : '', '</a></td>

						<td class="catbg3" width="11%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=starter', 'starter' == $context['sort_by'] && 'up' == $context['sort_direction'] ? ';desc' : '', '">', $txt[109], 'starter'
						...
						<td class="catbg3" width="4%" align="center"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=replies', 'replies' == $context['sort_by'] && 'up' == $context['sort_direction'] ? ';desc' : '', '">', $txt[110], 'replies'
                                                                                                                                                                                                                                                                                    == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                                                   . $settings['images_url']
                                                                                                                                                                                                                                                                                                   . '/sort_'
                                                                                                                                                                                                                                                                                                   . $context['sort_direction']
						...
						<td class="catbg3" width="4%" align="center"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=views', 'views' == $context['sort_by'] && 'up' == $context['sort_direction'] ? ';desc' : '', '">', $txt[301], 'views'
                                                                                                                                                                                                                                                                                == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                                             . $settings['images_url']
                                                                                                                                                                                                                                                                                             . '/sort_'
                                                                                                                                                                                                                                                                                             . $context['sort_direction']
						...
						<td class="catbg3" width="22%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=last_post', 'last_post' == $context['sort_by'] && 'up' == $context['sort_direction'] ? ';desc' : '', '">', $txt[111], 'last_post'
                                                                                                                                                                                                                                                                          == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                                           . $settings['images_url']
                                                                                                                                                                                                                                                                                           . '/sort_'
                                                                                                                                                                                                                                                                                           . $context['sort_direction']
            ...
            if (!empty($options['display_quick_mod']) && 1 == $options['display_quick_mod']) {
                echo '
        ...
        if (!empty($settings['display_who_viewing'])) {
            ...
            echo $txt['who_and'], $context['view_num_guests'], ' ', 1 == $context['view_num_guests'] ? $txt['guest'] : $txt['guests'], $txt['who_viewing_board'], '
						</small></td>
					</tr>';
        }
        ...
        foreach ($context['topics'] as $topic) {
            ...
            echo '
					<tr>
						...
						<td class="windowbg', !empty($settings['seperate_sticky_lock']) && $topic['is_sticky'] ? '3' : '', '" valign="middle" ', (!empty($topic['quick_mod']['remove']) ? 'id="topic_'
                                                                                                                                                                                          . $topic['first_post']['id']
                                                                                                                                                                                          . '" onmouseout="mouse_on_div = 0;" onmouseover="mouse_on_div = 1;" ondblclick="modify_topic(\''
                                                                                                                                                                                          . $topic['id']
                                                                                                                                                                                          . '\', \''
                                                                                                                                                                                          . $topic['first_post']['id']
                                                                                                                                                                                          . '\', \''
            ...
            if (!empty($options['display_quick_mod'])) {
                ...
                if (1 == $options['display_quick_mod']) {
                    echo '
        ...
        if (!empty($options['display_quick_mod']) && 1 == $options['display_quick_mod'] && !empty($context['topics'])) {
            echo '
					<tr class="catbg">
    ...
    if (!$context['no_topic_listing']) {
        echo '
				...
				<td valign="top" style="padding-top: 2ex;" class="smalltext">
					...
					<img src="' . $settings['images_url'] . '/icons/quick_sticky.gif" alt="" align="middle"> ' . $txt['smf96'] . '<br>' : '') . ('1' == $modSettings['pollMode'] ? '
...
function theme_show_buttons()
{
    ...
    if ($context['can_mark_notify']) {
        $buttonArray[] = '<a href="'
                         ...
                         . ($context['is_marked_notify'] ? $txt['notification_disable_board'] : $txt['notification_enable_board'])
                         . '\');">'
                         . $txt[125]
                         . '</a>';
    }
