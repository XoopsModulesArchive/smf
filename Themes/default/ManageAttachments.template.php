...
function template_manage_files_above()
{
	...
	<table cellpadding="0" cellspacing="0" border="0" style="margin-left: 10px;">
        ...
        echo 'attachment_settings' == $context['selected'] ? '
			<td class="maintab_active_first">&nbsp;</td>' : '', '
			<td class="maintab_', 'attachment_settings' == $context['selected'] ? 'active_' : '', 'back"><a href="' . $scripturl . '?action=manageattachments">', $txt['attachment_manager_settings'], '</a></td>', 'attachment_settings' == $context['selected'] ? '
			<td class="maintab_active_last">&nbsp;</td>' : '';

        // Show the avatar settings button.

        echo 'avatar_settings' == $context['selected'] ? '
			<td class="maintab_active_first">&nbsp;</td>' : '', '
			<td class="maintab_', 'avatar_settings' == $context['selected'] ? 'active_' : '', 'back"><a href="' . $scripturl . '?action=manageattachments;sa=avatars">', $txt['attachment_manager_avatar_settings'], '</a></td>', 'avatar_settings' == $context['selected'] ? '
			<td class="maintab_active_last">&nbsp;</td>' : '';

        // Show the browse button.

        echo 'browse' == $context['selected'] ? '
			<td class="maintab_active_first">&nbsp;</td>' : '', '
			<td class="maintab_', 'browse' == $context['selected'] ? 'active_' : '', 'back"><a href="' . $scripturl . '?action=manageattachments;sa=browse">', $txt['attachment_manager_browse'], '</a></td>', 'browse' == $context['selected'] ? '
			<td class="maintab_active_last">&nbsp;</td>' : '';

        // Show the maintenance button.

        echo 'maintenance' == $context['selected'] ? '
			<td class="maintab_active_first">&nbsp;</td>' : '', '
			<td class="maintab_', 'maintenance' == $context['selected'] ? 'active_' : '', 'back"><a href="' . $scripturl . '?action=manageattachments;sa=maintenance">', $txt['attachment_manager_maintenance'], '</a></td>', 'maintenance' == $context['selected'] ? '
			<td class="maintab_active_last">&nbsp;</td>' : '';
        ...
        echo '
				', 'attachment_settings' == $context['selected'] ? '<a href="' . $scripturl . '?action=manageattachments"><img src="' . $settings['images_url'] . '/selected.gif" alt="&gt;" border="0"></a> ' : '', '<a href="'
                                                                                                                                                                                                                       . $scripturl
                                                                                                                                                                                                                       . '?action=manageattachments">', $txt['attachment_manager_settings'], '</a> | ';

        // Show the avatar settings button.

        echo '
				', 'avatar_settings' == $context['selected'] ? '<a href="' . $scripturl . '?action=manageattachments;sa=avatars"><img src="' . $settings['images_url'] . '/selected.gif" alt="&gt;" border="0"></a> ' : '', '<a href="'
                                                                                                                                                                                                                              . $scripturl
                                                                                                                                                                                                                              . '?action=manageattachments;sa=avatars">', $txt['attachment_manager_avatar_settings'], '</a> | ';

        // Show the browse button.

        echo '
				', 'browse' == $context['selected'] ? '<a href="' . $scripturl . '?action=manageattachments;sa=browse"><img src="' . $settings['images_url'] . '/selected.gif" alt="&gt;" border="0"></a> ' : '', '<a href="'
                                                                                                                                                                                                                    . $scripturl
                                                                                                                                                                                                                    . '?action=manageattachments;sa=browse">', $txt['attachment_manager_browse'], '</a> | ';

        // Show the maintenance button.

        echo '
				', 'maintenance' == $context['selected'] ? '<a href="' . $scripturl . '?action=manageattachments;sa=maintenance"><img src="' . $settings['images_url'] . '/selected.gif" alt="&gt;" border="0"></a> ' : '', '<a href="'
                                                                                                                                                                                                                              . $scripturl
                                                                                                                                                                                                                              . '?action=manageattachments;sa=maintenance">', $txt['attachment_manager_maintenance'], '</a>
			</td>
		</tr>
		<tr class="windowbg">
			<td class="smalltext" style="padding: 2ex;">
		...
		<tr class="titlebg">
			...
			<td>
				<select name="attachmentEnable" id="attachmentEnable">
					...
					<option value="1"', !empty($modSettings['attachmentEnable']) && 1 == $modSettings['attachmentEnable'] ? ' selected="selected"' : '', '>', $txt['attachment_mode_enable_all'], '</option>
					<option value="2"', !empty($modSettings['attachmentEnable']) && 2 == $modSettings['attachmentEnable'] ? ' selected="selected"' : '', '>', $txt['attachment_mode_disable_new'], '</option>
				</select>
			</td>
		</tr><tr class="windowbg2">
			<td colspan="2"><hr></td>
			...
			<td><input type="checkbox" name="attachmentCheckExtensions" id="attachmentCheckExtensions" value="1" class="check"', empty($modSettings['attachmentCheckExtensions']) ? '' : ' checked', '></td>
		</tr><tr class="windowbg2">
			...
			<td><input type="checkbox" name="attachmentEncryptFilenames" id="attachmentEncryptFilenames" value="1" class="check"', empty($modSettings['attachmentEncryptFilenames']) ? '' : ' checked', '></td>
		</tr><tr class="windowbg2">
			<td colspan="2"><hr></td>
		</tr><tr class="windowbg2">
			...
			<td><input type="checkbox" name="attachmentShowImages" id="attachmentShowImages" value="1" class="check"', empty($modSettings['attachmentShowImages']) ? '' : ' checked', '></td>
		</tr><tr class="windowbg2">
			<td width="50%" align="right"><label for="attachmentThumbnails">', $txt['attachmentThumbnails'], '</label>:</td>
			<td><input type="checkbox" name="attachmentThumbnails" id="attachmentThumbnails" value="1" class="check"', empty($modSettings['attachmentThumbnails']) ? '' : ' checked', '></td>
		</tr><tr class="windowbg2">
...
<form action="', $scripturl, '?action=manageattachments" method="post" accept-charset="', $context['character_set'], '">
    ...
    echo '
		<tr class="windowbg2">
			...
			<td><input type="checkbox" name="avatar_download_external" id="avatar_download_external" value="1" class="check"', empty($modSettings['avatar_download_external']) ? '' : ' checked', ' onchange="updateStatus()"></td>
		</tr><tr class="windowbg2">
			...
			<td>
				<select name="avatar_action_too_large" id="avatar_action_too_large">
					<option value="option_refuse"', 'option_refuse' == $modSettings['avatar_action_too_large'] ? ' selected="selected"' : '', '>', $txt['option_refuse'], '</option>
					<option value="option_html_resize"', 'option_html_resize' == $modSettings['avatar_action_too_large'] ? ' selected="selected"' : '', '>', $txt['option_html_resize'], '</option>
					<option value="option_js_resize"', 'option_js_resize' == $modSettings['avatar_action_too_large'] ? ' selected="selected"' : '', '>', $txt['option_js_resize'], '</option>
					<option value="option_download_and_resize"', 'option_download_and_resize' == $modSettings['avatar_action_too_large'] ? ' selected="selected"' : '', '>', $txt['option_download_and_resize'], '</option>
				</select>
			</td>
		</tr><tr>
    ...
    echo '
			...
			<td><input type="checkbox" name="avatar_resize_upload" id="avatar_resize_upload" value="1" class="check"', empty($modSettings['avatar_resize_upload']) ? '' : ' checked', '></td>
		</tr><tr class="windowbg2">
			...
			<td><input type="checkbox" name="avatar_download_png" id="avatar_download_png" value="1" class="check"', empty($modSettings['avatar_download_png']) ? '' : ' checked', '></td>
		</tr><tr class="windowbg2">
...
function template_browse()
{
    ...
    echo '
<form action="', $scripturl, '?action=manageattachments;sort=', $context['sort_by'], 'down' == $context['sort_direction'] ? ';desc' : '', ';sa=remove" method="post" accept-charset="', $context['character_set'], '" onsubmit="return confirm(\'', $txt['confirm_delete_attachments'], '\');">
	...
	<table cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 1ex; margin-left: 10px;">
        ...
        echo 'attachments' == $context['browse_type'] ? '
			<td class="maintab_active_first">&nbsp;</td>' : '', '
			<td class="maintab_', 'attachments' == $context['browse_type'] ? 'active_' : '', 'back"><a href="', $scripturl, '?action=manageattachments;sa=browse;sort=', $context['sort_by'], 'down'
                                                                                                                                                                                              == $context['sort_direction'] ? ';desc' : '', '">', $txt['attachment_manager_attachments'], '</a></td>', 'attachments'
                                                                                                                                                                                                                                                                                   == $context['browse_type'] ? '
			<td class="maintab_active_last">&nbsp;</td>' : '';

        echo 'avatars' == $context['browse_type'] ? '
			<td class="maintab_active_first">&nbsp;</td>' : '', '
			<td class="maintab_', 'avatars' == $context['browse_type'] ? 'active_' : '', 'back"><a href="', $scripturl, '?action=manageattachments;sa=browse;avatars;sort=', $context['sort_by'], 'down'
                                                                                                                                                                                                  == $context['sort_direction'] ? ';desc' : '', '">', $txt['attachment_manager_avatars'], '</a></td>', 'avatars'
                                                                                                                                                                                                                                                                                   == $context['browse_type'] ? '
			<td class="maintab_active_last">&nbsp;</td>' : '';

        echo 'thumbs' == $context['browse_type'] ? '
			<td class="maintab_active_first">&nbsp;</td>' : '', '
			<td class="maintab_', 'thumbs' == $context['browse_type'] ? 'active_' : '', 'back"><a href="', $scripturl, '?action=manageattachments;sa=browse;thumbs;sort=', $context['sort_by'], 'down'
                                                                                                                                                                                                == $context['sort_direction'] ? ';desc' : '', '">', $txt['attachment_manager_thumbs'], '</a></td>', 'thumbs'
                                                                                                                                                                                                                                                                                == $context['browse_type'] ? '
			<td class="maintab_active_last">&nbsp;</td>' : '';
	...
	<table border="0" align="center" cellspacing="1" cellpadding="4" class="bordercolor" width="100%">
		...
		<tr class="catbg">
			<td colspan="5">
				<a href="', $scripturl, '?action=manageattachments;sa=browse;sort=', $context['sort_by'], 'down' == $context['sort_direction'] ? ';desc' : '', '">', 'attachments' == $context['browse_type'] ? '<img src="'
                                                                                                                                                                                                                . $settings['images_url']
                                                                                                                                                                                                                . '/selected.gif" alt="&gt;" border="0"> ' : '', $txt['attachment_manager_attachments'], '</a>&nbsp;|&nbsp;
				<a href="', $scripturl, '?action=manageattachments;sa=browse;avatars;sort=', $context['sort_by'], 'down' == $context['sort_direction'] ? ';desc' : '', '">', 'avatars' == $context['browse_type'] ? '<img src="'
                                                                                                                                                                                                                    . $settings['images_url']
                                                                                                                                                                                                                    . '/selected.gif" alt="&gt;" border="0"> ' : '', $txt['attachment_manager_avatars'], '</a>&nbsp;|&nbsp;
				<a href="', $scripturl, '?action=manageattachments;sa=browse;thumbs;sort=', $context['sort_by'], 'down' == $context['sort_direction'] ? ';desc' : '', '">', 'thumbs' == $context['browse_type'] ? '<img src="'
                                                                                                                                                                                                                  . $settings['images_url']
                                                                                                                                                                                                                  . '/selected.gif" alt="&gt;" border="0"> ' : '', $txt['attachment_manager_thumbs'], '</a>
			</td>
		</tr><tr class="titlebg">';
    }

    echo '
			<td nowrap="nowrap"><a href="', $scripturl, '?action=manageattachments;sa=browse;', $context['browse_type'], ';sort=name', 'name' == $context['sort_by'] && 'up' == $context['sort_direction'] ? ';desc' : '', '">', $txt['smf213'], 'name' == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                                 . $settings['images_url']
                                                                                                                                                                                                                                                                                 . '/sort_'
                                                                                                                                                                                                                                                                                 . $context['sort_direction']
                                                                                                                                                                                                                                                                                 . '.gif" alt="">' : '', '</a></td>
			<td nowrap="nowrap"><a href="', $scripturl, '?action=manageattachments;sa=browse;', $context['browse_type'], ';sort=size', 'size' == $context['sort_by'] && 'up' == $context['sort_direction'] ? ';desc' : '', '">', $txt['smf214'], 'size' == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                                 . $settings['images_url']
                                                                                                                                                                                                                                                                                 . '/sort_'
                                                                                                                                                                                                                                                                                 . $context['sort_direction']
                                                                                                                                                                                                                                                                                 . '.gif" alt="">' : '', '</a></td>
			<td nowrap="nowrap"><a href="', $scripturl, '?action=manageattachments;sa=browse;', $context['browse_type'], ';sort=member', 'member' == $context['sort_by'] && 'up' == $context['sort_direction'] ? ';desc' : '', '">', 'avatars'
                                                                                                                                                                                                                                     == $context['browse_type'] ? $txt['attachment_manager_member'] : $txt[279], 'member'
                                                                                                                                                                                                                                                                                                   == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                                                                 . $settings['images_url']
                                                                                                                                                                                                                                                                                                                 . '/sort_'
                                                                                                                                                                                                                                                                                                                 . $context['sort_direction']
                                                                                                                                                                                                                                                                                                                 . '.gif" alt="">' : '', '</a></td>
			<td nowrap="nowrap"><a href="', $scripturl, '?action=manageattachments;sa=browse;', $context['browse_type'], ';sort=date', 'date' == $context['sort_by'] && 'up' == $context['sort_direction'] ? ';desc' : '', '">', 'avatars'
                                                                                                                                                                                                                                 == $context['browse_type'] ? $txt['attachment_manager_last_active'] : $txt[317], 'date'
                                                                                                                                                                                                                                                                                                    == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                                                                . $settings['images_url']
                                                                                                                                                                                                                                                                                                                . '/sort_'
                                                                                                                                                                                                                                                                                                                . $context['sort_direction']
    ...
    foreach ($context['posts'] as $post) {
		...
		<tr class="', $alternate ? 'windowbg' : 'windowbg2', '">
			...
			<td class="smalltext">', $post['time'], 'avatars' != $context['browse_type'] ? '<br>' . $txt['smf88'] . ' ' . $post['link'] : '', '</td>
