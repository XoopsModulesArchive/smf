						...
						<tr>
							<td colspan="3"><br>
								...
								<div style="width: 45%;">
									...
									<label for="show_complete"><input type="checkbox" name="show_complete" id="show_complete" value="1"', !empty($context['search_params']['show_complete']) ? ' checked' : '', ' class="check"> ', $txt['search_show_complete_messages'], '</label><br>
									<label for="subject_only"><input type="checkbox" name="subject_only" id="subject_only" value="1"', !empty($context['search_params']['subject_only']) ? ' checked' : '', ' class="check"> ', $txt['search_subject_only'], '</label>
								</div>
							</td>
						</tr><tr>
        ...
        if (!empty($context['search_params']['topic'])) {
            ...
            foreach ($context['board_columns'] as $board) {
                ...
                if (!empty($board) && empty($board['child_ids'])) {
                    echo '
									<label for="brd', $board['id'], '" style="margin-left: ', $board['child_level'], 'ex;"><input type="checkbox" id="brd', $board['id'], '" name="brd[', $board['id'], ']" value="', $board['id'], '"', $board['selected'] ? ' checked' : '', ' class="check">', $board['name'], '</label>';
                } elseif (!empty($board)) {
                    echo '
            ...
            echo '
						...
						<input type="checkbox" name="all" id="check_all" value="" checked onclick="invertAll(this, this.form, \'brd\');" class="check"><i> <label for="check_all">', $txt[737], '</label></i><br>
					</fieldset> ';
        }
