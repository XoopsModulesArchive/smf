...
function template_wap_messageindex()
{
	...
	<card id="main" title="', $context['page_title'], '">
		...
		<p>', $txt[139], ': ', !empty($context['links']['prev']) ? '<a href="'
                                                                   . $context['links']['first']
                                                                   . ';wap">&lt;&lt;</a> <a href="'
                                                                   . $context['links']['prev']
                                                                   . ';wap">&lt;</a> ' : '', '(', $context['page_info']['current_page'], '/', $context['page_info']['num_pages'], ')', !empty($context['links']['next']) ? ' <a href="'
                                                                                                                                                                                                                           . $context['links']['next']
                                                                                                                                                                                                                           . ';wap">&gt;</a> <a href="'
                                                                                                                                                                                                                           . $context['links']['last']
                                                                                                                                                                                                                           . ';wap">&gt;&gt;</a> ' : '', '<br></p>';
...
function template_wap_display()
{
    ...
    while ($message = $context['get_message']()) {
        ...
        $wireless_message = strip_tags(str_replace(['<div class="quote">', '<div class="code">', '</div>'], ['', '', '<br>--<br>'], $message['body']), '<br>');
...
function template_wap_recent()
{
	...
	<card id="recent" title="', $context['page_title'], '">
		<p><b>', 'unread' == $_REQUEST['action'] ? $txt['wireless_recent_unread_posts'] : $txt['wireless_recent_unread_replies'], '</b></p>';
...
function template_imode_boardindex()
{
    ...
    foreach ($context['categories'] as $category) {
        ...
        foreach ($category['boards'] as $board) {
            ...
            echo '
			<tr><td>', $board['new'] ? '<font color="#ff0000">' : '', $count < 10 ? '&#' . (59105 + $count) . ';' : '<b>-</b>', $board['new'] ? '</font>' : ($board['children_new'] ? '<font color="#ff0000">.</font>' : ''), ' <a href="', $scripturl, '?board=', $board['id'], '.0;imode"', $count
                                                                                                                                                                                                                                                                                              < 10 ? ' accesskey="'
                                                                                                                                                                                                                                                                                                     . $count
                                                                                                                                                                                                                                                                                                     . '"' : '', '>', $board['name'], '</a></td></tr>';
        }
...
function template_imode_messageindex()
{
    ...
    if (!empty($context['topics'])) {
        echo '
			...
			<tr><td>', !empty($context['links']['prev']) ? '<a href="'
                                                           . $context['links']['first']
                                                           . ';imode">&lt;&lt;</a> <a href="'
                                                           . $context['links']['prev']
                                                           . ';imode">&lt;</a> ' : '', '(', $context['page_info']['current_page'], '/', $context['page_info']['num_pages'], ')', !empty($context['links']['next']) ? ' <a href="'
                                                                                                                                                                                                                     . $context['links']['next']
                                                                                                                                                                                                                     . ';imode">&gt;</a> <a href="'
                                                                                                                                                                                                                     . $context['links']['last']
                                                                                                                                                                                                                     . ';imode">&gt;&gt;</a> ' : '', '</td></tr>';
        ...
        foreach ($context['topics'] as $topic) {
            ...
            echo '
			<tr><td>', $count < 10 ? '&#' . (59105 + $count) . '; ' : '', '<a href="', $scripturl, '?topic=', $topic['id'], '.0;imode"', $count < 10 ? ' accesskey="' . $count . '"' : '', '>', $topic['first_post']['subject'], '</a>', $topic['new'] && $context['user']['is_logged'] ? ' [<a href="'
                                                                                                                                                                                                                                                                                          . $scripturl
                                                                                                                                                                                                                                                                                          . '?topic='
                                                                                                                                                                                                                                                                                          . $topic['id']
                                                                                                                                                                                                                                                                                          . '.msg'
...
function template_imode_display()
{
    ...
    while ($message = $context['get_message']()) {
        ...
        $wireless_message = strip_tags(str_replace(['<div class="quote">', '<div class="code">', '</div>'], '<br>', $message['body']), '<br>');
    ...
    echo '
		<form action="', $scripturl, '?action=', $context['destination'], ';board=', $context['current_board'], '.0;imode" method="post">
			<table border="0" cellspacing="0" cellpadding="0">', $context['locked'] ? '
				...
				<tr><td>
					&#59115; ', isset($context['current_topic']) ? '<a href="' . $scripturl . '?topic=' . $context['current_topic'] . '.new;imode">' . $txt['wireless_navigation_topic'] . '</a>' : '<a href="'
                                                                                                                                                                                                    . $scripturl
                                                                                                                                                                                                    . '?board='
    ...
    if ('findmember' == $_REQUEST['action']) {
		...
		<form action="', $scripturl, '?action=findmember;sesc=', $context['session_id'], ';imode" method="post">
			<table border="0" cellspacing="0" cellpadding="0">
				...
				<tr><td>
					...
					<input type="text" name="search" value="', $context['last_search'] ?? '', '">', empty($_REQUEST['u']) ? '' : '
        ...
        if (!empty($context['last_search'])) {
            ...
            if (empty($context['results'])) {
                ...
                echo '
				<tr bgcolor="#b6dbff"><td>', empty($context['links']['prev']) ? '' : '<a href="'
                                                                                     . $context['links']['first']
                                                                                     . ';imode">&lt;&lt;</a> <a href="'
                                                                                     . $context['links']['prev']
                                                                                     . ';imode">&lt;</a> ', '(', $context['page_info']['current_page'], '/', $context['page_info']['num_pages'], ')', empty($context['links']['next']) ? '' : ' <a href="'
        ...
        while ($message = $context['get_pmessage']()) {
            ...
            echo '
			<tr><td>
				', $count < 10 ? '&#' . (59105 + $count) . '; ' : '', '<a href="', $scripturl, '?action=pm;start=', $context['start'], ';pmsg=', $message['id'], ';imode"', $count < 10 ? ' accesskey="'
                                                                                                                                                                                          . $count
                                                                                                                                                                                          . '"' : '', '>', $message['subject'], ' <i>', $txt['wireless_pm_by'], '</i> ', $message['member']['name'], '</a>
			</tr></td>';
        }
        ...
        $message['body'] = strtr(strip_tags(strtr($message['body'], ['</div>' => '[br]', '<div class="quoteheader">' => '[br]'])), ['[br]' => '<br>']);
...
function template_imode_recent()
{
    ...
    echo '
		<table border="0" cellspacing="0" cellpadding="0">
			<tr bgcolor="#6d92aa"><td><font color="#ffffff">', 'unread' == $_REQUEST['action'] ? $txt['wireless_recent_unread_posts'] : $txt['wireless_recent_unread_replies'], '</tr></td>';
...
function template_wap2_boardindex()
{
    ...
    foreach ($context['categories'] as $category) {
        ...
        foreach ($category['boards'] as $board) {
            ...
            echo '
		<p class="windowbg">', $board['new'] ? '<span class="updated">' : '', $count < 10 ? '[' . $count . '' : '[-', $board['children_new'] ? '<span class="updated">' : '', '] ', $board['new']
                                                                                                                                                                                    || $board['children_new'] ? '</span>' : '', '<a href="', $scripturl, '?board=', $board['id'], '.0;wap2"', $count
                                                                                                                                                                                                                                                                                              < 10 ? ' accesskey="'
                                                                                                                                                                                                                                                                                                     . $count
                                                                                                                                                                                                                                                                                                     . '"' : '', '>', $board['name'], '</a></p>';
        }
...
function template_wap2_messageindex()
{
    ...
    if (!empty($context['topics'])) {
		...
		<p class="windowbg">', !empty($context['links']['prev']) ? '<a href="'
                                                                   . $context['links']['first']
                                                                   . ';wap2">&lt;&lt;</a> <a href="'
                                                                   . $context['links']['prev']
                                                                   . ';wap2">&lt;</a> ' : '', '(', $context['page_info']['current_page'], '/', $context['page_info']['num_pages'], ')', !empty($context['links']['next']) ? ' <a href="'
                                                                                                                                                                                                                            . $context['links']['next']
                                                                                                                                                                                                                            . ';wap2">&gt;</a> <a href="'
                                                                                                                                                                                                                            . $context['links']['last']
                                                                                                                                                                                                                            . ';wap2">&gt;&gt;</a> ' : '', '</p>';
        ...
        foreach ($context['topics'] as $topic) {
            ...
            echo '
		<p class="windowbg">', $count < 10 ? '[' . $count . '] ' : '', '<a href="', $scripturl, '?topic=', $topic['id'], '.0;wap2"', $count < 10 ? ' accesskey="' . $count . '"' : '', '>', $topic['first_post']['subject'], '</a>', $topic['new'] && $context['user']['is_logged'] ? ' [<a href="'
                                                                                                                                                                                                                                                                                      . $scripturl
                                                                                                                                                                                                                                                                                      . '?topic='
                                                                                                                                                                                                                                                                                      . $topic['id']
                                                                                                                                                                                                                                                                                      . '.msg'
...
function template_wap2_post()
{
    ...
    echo '
		<form action="', $scripturl, '?action=', $context['destination'], ';board=', $context['current_board'], '.0;wap2" method="post">
			...
			<p class="windowbg">[0] ', isset($context['current_topic']) ? '<a href="' . $scripturl . '?topic=' . $context['current_topic'] . '.new;wap2">' . $txt['wireless_navigation_topic'] . '</a>' : '<a href="'
                                                                                                                                                                                                          . $scripturl
                                                                                                                                                                                                          . '?board='
                                                                                                                                                                                                          . $context['current_board']
                                                                                                                                                                                                          . '.0;wap2" accesskey="0">'
...
function template_wap2_recent()
{
    ...
    echo '
		<p class="catbg">', 'unread' == $_REQUEST['action'] ? $txt['wireless_recent_unread_posts'] : $txt['wireless_recent_unread_replies'], '</p>';
