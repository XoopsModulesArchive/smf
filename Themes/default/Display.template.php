...
<table cellpadding="3" cellspacing="0" border="0" width="100%" class="tborder" style="padding-top: 0; margin-bottom: 3ex;">
    ...
    $normal_buttons = [
        'reply' => ['test' => 'can_reply', 'text' => 146, 'image' => 'reply.gif', 'lang' => true, 'url' => $scripturl . '?action=post;topic=' . $context['current_topic'] . '.' . $context['start'] . ';num_replies=' . $context['num_replies']],
        'notify' => [
        ...
        'custom' => [],
        'send' => ['test' => 'can_send_topic', 'text' => 707, 'image' => 'sendtopic.gif', 'lang' => true, 'url' => $scripturl . '?action=sendtopic;topic=' . $context['current_topic'] . '.0'],
        'print' => ['text' => 465, 'image' => 'print.gif', 'lang' => true, 'custom' => 'target="_blank"', 'url' => $scripturl . '?action=printpage;topic=' . $context['current_topic'] . '.0'],
    ];

    // Special case for the custom one.

    if ($context['user']['is_logged'] && $settings['show_mark_read']) {
        $normal_buttons['custom'] = ['text' => 'mark_unread', 'image' => 'markunread.gif', 'lang' => true, 'url' => $scripturl . '?action=markasread;sa=topic;t=' . $context['mark_unread_time'] . ';topic=' . $context['current_topic'] . '.' . $context['start'] . ';sesc=' . $context['session_id']];
    } elseif ($context['can_add_poll']) {
        $normal_buttons['custom'] = ['text' => 'add_poll', 'image' => 'add_poll.gif', 'lang' => true, 'url' => $scripturl . '?action=editpoll;add;topic=' . $context['current_topic'] . '.' . $context['start'] . ';sesc=' . $context['session_id']];
    } else {
...
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="tborder" style="border-bottom: 0;">
    ...
    if (!empty($settings['display_who_viewing'])) {
        ...
        if (1 == $settings['display_who_viewing']) {
            echo count($context['view_members']), ' ', 1 == count($context['view_members']) ? $txt['who_member'] : $txt[19];
        ...
        echo $txt['who_and'], $context['view_num_guests'], ' ', 1 == $context['view_num_guests'] ? $txt['guest'] : $txt['guests'], $txt['who_viewing_topic'], '
				</td>
		</tr>';
    }
    ...
    echo '
<form action="', $scripturl, '?action=quickmod2;topic=', $context['current_topic'], '.', $context['start'], '" method="post" accept-charset="', $context['character_set'], '" name="quickModForm" id="quickModForm" style="margin: 0;" onsubmit="return in_edit_mode == 1 ? modify_save(\''
                                                                                                                                                                           . $context['session_id']
                                                                                                                                                                           . '\') : confirm(\''
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="bordercolor">';
	...
	<tr><td style="padding: 1px 1px 0 1px;">';
		...
		<table width="100%" cellpadding="3" cellspacing="0" border="0">
			<tr><td class="', 0 == $message['alternate'] ? 'windowbg' : 'windowbg2', '">';
        ...
        if (!$message['member']['is_guest']) {
            ...
            if (!empty($modSettings['onlineEnable']) && !$message['member']['is_guest']) {
                echo '
								', $context['can_send_pm'] ? '<a href="' . $message['member']['online']['href'] . '" title="' . $message['member']['online']['label'] . '">' : '', $settings['use_image_buttons'] ? '<img src="'
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    . '" border="0" style="margin-top: 2px;">' : $message['member']['online']['text'], $context['can_send_pm'] ? '</a>' : '', $settings['use_image_buttons'] ? '<span class="smalltext"> '
                                                                                                                                                                                                                                                                                                                                                                                 . $message['member']['online']['text']
                                                                                                                                                                                                                                                                                                                                                                                 . '</span>' : '', '<br><br>';
            }
            ...
            if ($settings['show_profile_buttons']) {
                ...
                if ('' != $message['member']['website']['url']) {
                    echo '
								<a href="', $message['member']['website']['url'], '" title="' . $message['member']['website']['title'] . '" target="_blank">', ($settings['use_image_buttons'] ? '<img src="'
                                                                                                                                                                                                 . $settings['images_url']
                                                                                                                                                                                                 . '/www_sm.gif" alt="'
                                                                                                                                                                                                 . $txt[515]
                                                                                                                                                                                                 . '" border="0">' : $txt[515]), '</a>';
                ...
                if ($context['can_send_pm']) {
                    echo '
								<a href="', $scripturl, '?action=pm;sa=send;u=', $message['member']['id'], '" title="', $message['member']['online']['label'], '">', $settings['use_image_buttons'] ? '<img src="'
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      . '" border="0">' : $message['member']['online']['label'], '</a>';
                }
            }
        ...
        if (!empty($options['display_quick_mod']) && 1 == $options['display_quick_mod'] && $message['can_remove']) {
            echo '
        ...
        if (!empty($message['attachment'])) {
            ...
            foreach ($message['attachment'] as $attachment) {
                ...
                echo '
										<a href="' . $attachment['href'] . '"><img src="' . $settings['images_url'] . '/icons/clip.gif" align="middle" alt="*" border="0">&nbsp;' . $attachment['name'] . '</a> (', $attachment['size'], ($attachment['is_image'] ? ', '
                                                                                                                                                                                                                                                                      . $attachment['real_width']
                                                                                                                                                                                                                                                                      . 'x'
                                                                                                                                                                                                                                                                      . $attachment['real_height']
                                                                                                                                                                                                                                                                      . ' - '
                                                                                                                                                                                                                                                                      . $txt['attach_viewed'] : ' - '
...
<script language="JavaScript" type="text/javascript"><!-- // --><![CDATA[
	quickReplyCollapsed = ', !empty($options['display_quick_reply']) && 2 == $options['display_quick_reply'] ? 'false' : 'true', ';
	...
	var smf_template_body_edit = \'<div id="error_box" style="padding: 4px; color: red;"></div><textarea class="editor" name="message" rows="12" style="width: 94%; margin-bottom: 10px;">%body%</textarea><br><input type="hidden" name="sc" value="', $context['session_id'], '"><input type="hidden" name="topic" value="', $context['current_topic'], '"><input type="hidden" name="msg" value="%msg_id%"><div style="text-align: center;"><input type="submit" name="post" value="', $txt[10], '" onclick="return modify_save(\\\''
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            . $context['session_id']
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            . '\\\');" accesskey="s">&nbsp;&nbsp;', $context['show_spellchecking'] ? '<input type="button" value="'
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       . $txt['spell_check']
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       . '" onclick="spellCheck(\\\'quickModForm\\\', \\\'message\\\');">&nbsp;&nbsp;' : '', '<input type="submit" name="cancel" value="', $txt['modify_cancel'], '" onclick="return modify_cancel();"></div>\';
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 1ex;">
    ...
    $mod_buttons = [
        'move' => ['test' => 'can_move', 'text' => 132, 'image' => 'admin_move.gif', 'lang' => true, 'url' => $scripturl . '?action=movetopic;topic=' . $context['current_topic'] . '.0'],
        'delete' => ['test' => 'can_delete', 'text' => 63, 'image' => 'admin_rem.gif', 'lang' => true, 'custom' => 'onclick="return confirm(\'' . $txt[162] . '\');"', 'url' => $scripturl . '?action=removetopic2;topic=' . $context['current_topic'] . '.0;sesc=' . $context['session_id']],
        'lock' => ['test' => 'can_lock', 'text' => empty($context['is_locked']) ? 'smf279' : 'smf280', 'image' => 'admin_lock.gif', 'lang' => true, 'url' => $scripturl . '?action=lock;topic=' . $context['current_topic'] . '.' . $context['start'] . ';sesc=' . $context['session_id']],
        'sticky' => ['test' => 'can_sticky', 'text' => empty($context['is_sticky']) ? 'smf277' : 'smf278', 'image' => 'admin_sticky.gif', 'lang' => true, 'url' => $scripturl . '?action=sticky;topic=' . $context['current_topic'] . '.' . $context['start'] . ';sesc=' . $context['session_id']],
        'merge' => ['test' => 'can_merge', 'text' => 'smf252', 'image' => 'merge.gif', 'lang' => true, 'url' => $scripturl . '?action=mergetopics;board=' . $context['current_board'] . '.0;from=' . $context['current_topic']],
        'remove_poll' => [
        ...
        'calendar' => ['test' => 'calendar_post', 'text' => 'calendar37', 'image' => 'linktocal.gif', 'lang' => true, 'url' => $scripturl . '?action=post;calendar;msg=' . $context['topic_first_message'] . ';topic=' . $context['current_topic'] . '.0;sesc=' . $context['session_id']],
    ];

    if ($context['can_remove_post'] && !empty($options['display_quick_mod']) && 1 == $options['display_quick_mod']) {
        $mod_buttons[] = ['text' => 'quickmod_delete_selected', 'image' => 'delete_selected.gif', 'lang' => true, 'custom' => 'onclick="return confirm(\'' . $txt['quickmod_confirm'] . '\');" id="quickmodSubmit"', 'url' => 'javascript:document.quickModForm.submit();'];
    }
    ...
    if (!empty($options['display_quick_mod']) && 1 == $options['display_quick_mod'] && $context['can_remove_post']) {
        echo '
	<input type="hidden" name="sc" value="', $context['session_id'], '">';
    }
...
<table border="0" cellspacing="1" cellpadding="3" class="bordercolor" width="100%" style="clear: both;">
		<tr>
				<td colspan="2" class="catbg"><a href="javascript:swapQuickReply();"><img src="', $settings['images_url'], '/', 2 == $options['display_quick_reply'] ? 'collapse' : 'expand', '.gif" alt="+" id="quickReplyExpand"></a> <a href="javascript:swapQuickReply();">', $txt['quick_reply_1'], '</a></td>
		</tr>
	<tr id="quickReplyOptions"', 2 == $options['display_quick_reply'] ? '' : ' style="display: none"', '>
