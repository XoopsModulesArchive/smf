...
<smf>
	...
	<errors serious="', empty($context['error_type']) || 'serious' != $context['error_type'] ? '0' : '1', '" topic_locked="', $context['locked'] ? '1' : '0', '">';
	...
	<num_replies>', $context['num_replies'] ?? '0', '</num_replies>';
...
<smf>';
	...
	<month id="', $month['date']['year'], $month['date']['month'], '">';
        ...
        foreach ($month['days'] as $day) {
            echo '
		<day date="', $day['year'], '-', $day['month'], '-', $day['day'], '" new_topics="', $day['new_topics'], '" new_posts="', $day['new_posts'], '" new_members="', $day['new_members'], '" most_members_online="', $day['most_members_online'], '"', empty($modSettings['hitStats']) ? '' : ' hits="'
                                                                                                                                                                                                                                                                                                . $day['hits']
                                                                                                                                                                                                                                                                                                . '"', '>';
        }
