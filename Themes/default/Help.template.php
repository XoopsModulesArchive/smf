...
<html xmlns="http://www.w3.org/1999/xhtml"', $context['right_to_left'] ? ' dir="rtl"' : '', '>
			...
			<table border="0" width="100%" cellpadding="4" cellspacing="0" class="tborder">
				...
				<tr class="windowbg">
					<td align="left" colspan="2">
						...
						<input type="text" name="search" id="search" value="', $context['last_search'] ?? '', '" style="margin-top: 4px; width: 96%;"><br>
					</td>
				</tr>
    ...
    if (!empty($context['show_buddies'])) {
        echo '
					<td align="left">
						<span class="smalltext"><label for="buddies"><input type="checkbox" class="check" name="buddies" id="buddies"', !empty($context['buddy_search']) ? ' checked' : '', '> ', $txt['find_buddies'], '</label></span>
					</td>
					<td align="right">';
    } else {
        echo '
...
//]]>
    ...
    $mark_read_button = ['markread' => ['text' => 452, 'image' => 'markread.gif', 'lang' => true, 'url' => 'javascript:markBoardRead();']];
...
//]]>
    ...
    $mindex_buttons = [
        'markmread' => ['text' => 'mark_read_short', 'image' => 'markread.gif', 'lang' => true, 'url' => 'javascript:markMessageRead();'],
        'notify' => ['text' => 'manual_index_notify', 'image' => 'notify.gif', 'lang' => true, 'custom' => 'onclick="return confirm(\'' . $txt['manual_index_ru_sure_notify'] . '\');"', 'url' => $scripturl . '?action=help;page=index#message'],
        'topic' => ['text' => 'manual_index_start_new', 'image' => 'new_topic.gif', 'lang' => true, 'url' => $scripturl . '?action=help;page=post#newtopic'],
        'poll' => ['text' => 'manual_index_new_poll', 'image' => 'new_poll.gif', 'lang' => true, 'url' => $scripturl . '?action=help;page=post#newpoll'],
    ];
    ...
    $display_buttons = [
        'reply' => ['text' => 'manual_index_reply', 'image' => 'reply.gif', 'lang' => true, 'url' => $scripturl . '?action=help;page=post#reply'],
        'notify' => ['text' => 'manual_index_notify', 'image' => 'notify.gif', 'lang' => true, 'custom' => 'onclick="return confirm(\'' . $txt['manual_index_ru_sure_enable_notify'] . '\');"', 'url' => $scripturl . '?action=help;page=post#topic'],
        'markunread' => ['text' => 'manual_index_mark_unread', 'image' => 'markunread.gif', 'lang' => true, 'url' => $scripturl . '?action=help;page=post#topic'],
        'sendtopic' => ['text' => 'manual_index_send_topic', 'image' => 'sendtopic.gif', 'lang' => true, 'url' => $scripturl . '?action=help;page=post#topic'],
        'print' => ['text' => 'manual_index_print', 'image' => 'print.gif', 'lang' => true, 'url' => $scripturl . '?action=help;page=post#topic'],
    ];
						...
						<td class="windowbg">
							...
							<table width="80%" border="0" cellpadding="1" cellspacing="0">
								<tr>
									...
									<td width="50%"><input type="checkbox" id="brd2" name="brd[2]" value="2" checked class="check"> <label for="brd2">', $txt['manual_searching_another_board'], '</label></td>
								</tr>
								<tr>
									<td width="50%"><input type="checkbox" id="brd1" name="brd[1]" value="1" checked class="check"> <label for="brd1">', $txt['manual_searching_board_name'], '</label></td>
								</tr>
							</table><br>
							<input type="checkbox" name="all" id="check_all" value="" checked onclick="invertAll(this, this.form, \'brd\');" class="check"><i><label for="check_all">', $txt['manual_searching_check_all'], '</label></i><br>
							<br>
