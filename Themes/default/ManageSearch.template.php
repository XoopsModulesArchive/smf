...
function template_modify_settings()
{
    ...
    echo '
			<tr class="windowbg2">
				...
				<td><input type="checkbox" name="simpleSearch" id="simpleSearch_check"', empty($modSettings['simpleSearch']) ? '' : ' checked', ' class="check"></td>
...
function template_select_search_method()
{
    ...
    echo '
			<tr class="windowbg2">
				...
				<td width="3%" align="center" valign="top" class="windowbg"><input type="radio" name="search_index" value=""', empty($modSettings['search_index']) ? ' checked' : '', '></td>
				<td>
					', $txt['search_index_none'], '
				</td>
			</tr><tr class="windowbg2">
				<td></td>
				<td width="3%" align="center" valign="top" class="windowbg"><input type="radio" name="search_index" value="fulltext"', !empty($modSettings['search_index'])
                                                                                                                                       && 'fulltext' == $modSettings['search_index'] ? ' checked' : '', empty($context['fulltext_index']) ? ' onclick="alert(\''
    ...
    echo '
				...
				<td align="right"></td>
				<td width="3%" align="center" valign="top" class="windowbg"><input type="radio" name="search_index" value="custom"', !empty($modSettings['search_index']) && 'custom' == $modSettings['search_index'] ? ' checked' : '', $context['custom_index'] ? '' : ' onclick="alert(\''
                                                                                                                                                                                                                                                                                   . $txt['search_index_custom_warning']
                                                                                                                                                                                                                                                                                   . '\'); selectRadioByName(this.form.search_method, \'1\');"', '></td>
				<td>
    ...
    echo '
				...
				<td colspan="2"><input type="checkbox" name="search_force_index" id="search_force_index_check" value="1"', empty($modSettings['search_force_index']) ? '' : ' checked', '></td>
			</tr><tr class="windowbg2">
				<th align="right"><label for="search_match_words_check">', $txt['search_match_words'], ':</label></th>
				<td colspan="2"><input type="checkbox" name="search_match_words" id="search_match_words_check" value="1"', empty($modSettings['search_match_words']) ? '' : ' checked', '></td>
			</tr><tr class="windowbg2">
				<td></td>
				<td align="right" colspan="2">
