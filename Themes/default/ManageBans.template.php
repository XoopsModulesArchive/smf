        ...
        echo '
			<tr>
				...
				<td align="center" valign="top" class="windowbg2">
					&nbsp;<a href="', $scripturl, '?action=ban;sa=edit;sort=', $context['sort_by'], 'up' == $context['sort_direction'] ? ';desc' : '', ';bg=', $ban['id'], '">', $txt[17], '</a>
				</td>
				...
				<form action="', $scripturl, '?action=ban;sa=edit" method="post" accept-charset="', $context['character_set'], '" onsubmit="if (this.ban_name.value == \'\') {alert(\'', $txt['ban_name_empty'], '\'); return false;} if (this.partial_ban.checked &amp;&amp; !(this.cannot_post.checked || this.cannot_register.checked || this.cannot_login.checked)) {alert(\'', $txt['ban_restriction_empty'], '\'); return false;}">
					<table cellpadding="4">
						<tr>
							...
							<td align="left"><input type="radio" name="expiration" value="never" id="never_expires" onclick="updateStatus();"', 'never' == $context['ban']['expiration']['status'] ? ' checked' : '', ' class="check">&nbsp;&nbsp;<label for="never_expires">', $txt['never'], '</label><br>
							<input type="radio" name="expiration" value="one_day" id="expires_one_day" onclick="updateStatus();"', 'still_active_but_we_re_counting_the_days'
                                                                                                                                   == $context['ban']['expiration']['status'] ? ' checked' : '', ' class="check">&nbsp;&nbsp;<label for="expires_one_day">', $txt['ban_will_expire_within'], '</label>: <input type="text" name="expire_date" id="expire_date" size="3" value="', $context['ban']['expiration']['days'], '"> ', $txt['ban_days'], '<br>
							<input type="radio" name="expiration" value="expired" id="already_expired" onclick="updateStatus();"', 'expired' == $context['ban']['expiration']['status'] ? ' checked' : '', ' class="check">&nbsp;&nbsp;<label for="already_expired">', $txt['ban_expired'], '</label>
							</td>
						</tr><tr>
							...
							<td align="left">
								<input type="radio" name="full_ban" id="full_ban" value="1" onclick="updateStatus();"', $context['ban']['cannot']['access'] ? ' checked' : '', ' class="check">&nbsp;&nbsp;<label for="full_ban">', $txt['ban_full_ban'], '</label><br>
								<input type="radio" name="full_ban" id="partial_ban" value="0" onclick="updateStatus();"', !$context['ban']['cannot']['access'] ? ' checked' : '', ' class="check">&nbsp;&nbsp;<label for="partial_ban">', $txt['ban_partial_ban'], '</label><br>
								&nbsp;&nbsp;&nbsp;<input type="checkbox" name="cannot_post" id="cannot_post" value="1"', $context['ban']['cannot']['post'] ? ' checked' : '', ' class="check"> <label for="cannot_post">', $txt['ban_cannot_post'], '</label> (<a href="', $scripturl, '?action=helpadmin;help=ban_cannot_post" onclick="return reqWin(this.href);">?</a>)<br>
								&nbsp;&nbsp;&nbsp;<input type="checkbox" name="cannot_register" id="cannot_register" value="1"', $context['ban']['cannot']['register'] ? ' checked' : '', ' class="check"> <label for="cannot_register">', $txt['ban_cannot_register'], '</label><br>
								&nbsp;&nbsp;&nbsp;<input type="checkbox" name="cannot_login" id="cannot_login" value="1"', $context['ban']['cannot']['login'] ? ' checked' : '', ' class="check"> <label for="cannot_login">', $txt['ban_cannot_login'], '</label><br>
							</td>
						</tr>';
    ...
    if (!$context['ban']['is_new'] && empty($context['ban_suggestions'])) {
        ...
        if (empty($context['ban_items'])) {
            ...
            foreach ($context['ban_items'] as $ban_item) {
                ...
                } elseif ('hostname' == $ban_item['type']) {
                    echo '<b>', $txt['hostname'], ':</b>&nbsp;', $ban_item['hostname'];
                } elseif ('email' == $ban_item['type']) {
                    echo '<b>', $txt[69], ':</b>&nbsp;', $ban_item['email'];
                } elseif ('user' == $ban_item['type']) {
...
function template_ban_edit_trigger()
{
		...
		<table border="0" align="center" cellspacing="0" cellpadding="4" class="tborder" width="60%">
			...
			<tr class="windowbg">
				<td align="center">
					<table cellpadding="4">
						<tr>
							<td valign="bottom"><input type="radio" name="bantype" value="ip_ban"', $context['ban_trigger']['ip']['selected'] ? ' checked' : '', '></td>
							<td align="left" valign="top">
								', $txt['ban_on_ip'], ':<br>
    ...
    if (empty($modSettings['disableHostnameLookup'])) {
        echo '
							<td valign="bottom"><input type="radio" name="bantype" value="hostname_ban"', $context['ban_trigger']['hostname']['selected'] ? ' checked' : '', '></td>
							<td align="left" valign="top">
								', $txt['ban_on_hostname'], ':<br>
    ...
    echo '
							<td valign="bottom"><input type="radio" name="bantype" value="email_ban"', $context['ban_trigger']['email']['selected'] ? ' checked' : '', '></td>
							<td align="left" valign="top">
								', $txt['ban_on_email'], ':<br>
							...
							<td valign="bottom"><input type="radio" name="bantype" value="user_ban"', $context['ban_trigger']['banneduser']['selected'] ? ' checked' : '', '></td>
							<td align="left" valign="top">
								', $txt['ban_on_username'], ':<br>
...
<form action="', $scripturl, '?action=ban;sa=browse;entity=', $context['selected_entity'], '" method="post" accept-charset="', $context['character_set'], '" onsubmit="return confirm(\'', $txt['ban_remove_selected_triggers_confirm'], '\');">
	<table border="0" align="center" cellspacing="1" cellpadding="4" class="tborder" width="100%">
		<tr class="titlebg">
			...
			<td colspan="4">
				<a href="', $scripturl, '?action=ban;sa=browse;entity=ip">', 'ip' == $context['selected_entity'] ? '<img src="'
                                                                                                                   . $settings['images_url']
                                                                                                                   . '/selected.gif" alt="&gt;"> ' : '', $txt[512], '</a>&nbsp;|&nbsp;<a href="', $scripturl, '?action=ban;sa=browse;entity=hostname">', 'hostname'
                                                                                                                                                                                                                                                           == $context['selected_entity'] ? '<img src="'
                                                                                                                                                                                                                                                                           . $settings['images_url']
                                                                                                                                                                                                                                                                           . '/selected.gif" alt="&gt;"> ' : '', $txt['hostname'], '</a>&nbsp;|&nbsp;<a href="', $scripturl, '?action=ban;sa=browse;entity=email">', 'email'
                                                                                                                                                                                                                                                                                                                                                                                                                       == $context['selected_entity'] ? '<img src="'
                                                                                                                                                                                                                                                                                                                                                                                                                                    . $settings['images_url']
                                                                                                                                                                                                                                                                                                                                                                                                                                    . '/selected.gif" alt="&gt;"> ' : '', $txt[69], '</a>&nbsp;|&nbsp;<a href="', $scripturl, '?action=ban;sa=browse;entity=member">', 'member'
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         == $context['selected_entity'] ? '<img src="'
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       . $settings['images_url']
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       . '/selected.gif" alt="&gt;"> ' : '', $txt[35], '</a>
			</td>
		</tr><tr class="titlebg">
	...
	<form action="', $scripturl, '?action=ban;sa=log" method="post" accept-charset="', $context['character_set'], '">
		<table border="0" align="center" cellspacing="1" cellpadding="4" class="bordercolor" width="100%">
			<tr class="catbg3">
				...
				<th>
					<a href="', $scripturl, '?action=ban;sa=log;sort=ip', 'up' == $context['sort_direction'] ? ';desc' : '', ';start=', $context['start'], '">' . $txt['ban_log_ip'], 'ip' == $context['sort'] ? '&nbsp;<img src="'
                                                                                                                                                                                                                 . $settings['images_url']
                                                                                                                                                                                                                 . '/sort_'
				...
				<th>
					<a href="', $scripturl, '?action=ban;sa=log;sort=email', 'up' == $context['sort_direction'] ? ';desc' : '', ';start=', $context['start'], '">' . $txt['ban_log_email'], 'email' == $context['sort'] ? '&nbsp;<img src="'
                                                                                                                                                                                                                          . $settings['images_url']
                                                                                                                                                                                                                          . '/sort_'
                                                                                                                                                                                                                          . $context['sort_direction']
                                                                                                                                                                                                                          . '.gif" alt="">' : '', '</a>
				...
				<th>
					<a href="', $scripturl, '?action=ban;sa=log;sort=name', 'up' == $context['sort_direction'] ? ';desc' : '', ';start=', $context['start'], '">' . $txt['ban_log_member'], 'name' == $context['sort'] ? '&nbsp;<img src="'
                                                                                                                                                                                                                         . $settings['images_url']
                                                                                                                                                                                                                         . '/sort_'
                                                                                                                                                                                                                         . $context['sort_direction']
                                                                                                                                                                                                                         . '.gif" alt="">' : '', '</a>
				...
				<th>
					<a href="', $scripturl, '?action=ban;sa=log;sort=date', 'up' == $context['sort_direction'] ? ';desc' : '', ';start=', $context['start'], '">' . $txt['ban_log_date'], 'date' == $context['sort'] ? '&nbsp;<img src="'
                                                                                                                                                                                                                       . $settings['images_url']
                                                                                                                                                                                                                       . '/sort_'
                                                                                                                                                                                                                       . $context['sort_direction']
                                                                                                                                                                                                                       . '.gif" alt="">' : '', '</a>
