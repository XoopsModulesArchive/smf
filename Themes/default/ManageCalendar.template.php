		...
		<tr class="titlebg">
			...
			<td>
				<select name="year" id="year" onchange="generateDays();">
					<option value="0000"', '0000' == $context['holiday']['year'] ? ' selected="selected"' : '', '>', $txt['every_year'], '</option>';
...
function template_modify_settings()
{
	...
	<form action="', $scripturl, '?action=managecalendar;sa=settings" method="post" accept-charset="', $context['character_set'], '">
		<table border="0" cellspacing="0" cellpadding="4" align="center" width="80%" class="tborder">
			...
			<tr class="windowbg2">
				...
				<td><input type="checkbox" name="cal_enabled" id="cal_enabled"', empty($modSettings['cal_enabled']) ? '' : ' checked', ' class="check"></td>
			</tr>';
    ...
    echo '
			<tr class="windowbg2">
				...
				<td><input type="checkbox" name="cal_daysaslink" id="cal_daysaslink"', empty($modSettings['cal_daysaslink']) ? '' : ' checked', ' class="check"></td>
			</tr><tr class="windowbg2">
				<td align="right"><label for="cal_showweeknum">', $txt['setting_cal_showweeknum'], '</label>:</td>
				<td><input type="checkbox" name="cal_showweeknum" id="cal_showweeknum"', empty($modSettings['cal_showweeknum']) ? '' : ' checked', ' class="check"></td>
			</tr><tr class="windowbg2">
				<td colspan="2"><hr width="90%"></td>
			</tr><tr class="windowbg2">
				...
				<td>
					<select name="cal_showholidays">
						<option value="never"', 'never' == $context['cal_showholidays'] ? ' selected="selected"' : '', '>', $txt['setting_cal_show_never'], '</option>
						<option value="cal"', 'cal' == $context['cal_showholidays'] ? ' selected="selected"' : '', '>', $txt['setting_cal_show_cal'], '</option>
						<option value="index"', 'index' == $context['cal_showholidays'] ? ' selected="selected"' : '', '>', $txt['setting_cal_show_index'], '</option>
						<option value="all"', 'all' == $context['cal_showholidays'] ? ' selected="selected"' : '', '>', $txt['setting_cal_show_all'], '</option>
					</select>
				</td>
			</tr><tr class="windowbg2">
				...
				<td>
					<select name="cal_showbdays">
						<option value="never"', 'never' == $context['cal_showbdays'] ? ' selected="selected"' : '', '>', $txt['setting_cal_show_never'], '</option>
						<option value="cal"', 'cal' == $context['cal_showbdays'] ? ' selected="selected"' : '', '>', $txt['setting_cal_show_cal'], '</option>
						<option value="index"', 'index' == $context['cal_showbdays'] ? ' selected="selected"' : '', '>', $txt['setting_cal_show_index'], '</option>
						<option value="all"', 'all' == $context['cal_showbdays'] ? ' selected="selected"' : '', '>', $txt['setting_cal_show_all'], '</option>
					</select>
				</td>
			</tr><tr class="windowbg2">
				...
				<td>
					<select name="cal_showevents">
						<option value="never"', 'never' == $context['cal_showevents'] ? ' selected="selected"' : '', '>', $txt['setting_cal_show_never'], '</option>
						<option value="cal"', 'cal' == $context['cal_showevents'] ? ' selected="selected"' : '', '>', $txt['setting_cal_show_cal'], '</option>
						<option value="index"', 'index' == $context['cal_showevents'] ? ' selected="selected"' : '', '>', $txt['setting_cal_show_index'], '</option>
						<option value="all"', 'all' == $context['cal_showevents'] ? ' selected="selected"' : '', '>', $txt['setting_cal_show_all'], '</option>
					</select>
				</td>
			</tr><tr class="windowbg2">
				<td colspan="2"><hr width="90%"></td>
    ...
    echo '
				...
				<td><input type="checkbox" name="cal_allow_unlinked" id="cal_allow_unlinked"', empty($modSettings['cal_allow_unlinked']) ? '' : ' checked', ' class="check"></td>
			</tr><tr class="windowbg2">
				<td align="right"><label for="cal_showInTopic">', $txt['setting_cal_showInTopic'], '</label>:</td>
				<td><input type="checkbox" name="cal_showInTopic" id="cal_showInTopic"', empty($modSettings['cal_showInTopic']) ? '' : ' checked', ' class="check"></td>
			</tr><tr class="windowbg2">
				<td colspan="2"><hr width="90%"></td>
			</tr><tr class="windowbg2">
				...
				<td><input type="checkbox" name="cal_allowspan" id="cal_allowspan"', empty($modSettings['cal_allowspan']) ? '' : ' checked', ' class="check"></td>
			</tr><tr class="windowbg2">
