...
function template_main()
{
    ...
    echo '
					<label for="postRedirect"><input type="checkbox" name="postRedirect" id="postRedirect" checked onclick="document.getElementById(\'reasonArea\').style.display = this.checked ? \'block\' : \'none\';" class="check"> ', $txt['moveTopic1'], '.</label><br>
