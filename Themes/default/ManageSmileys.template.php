...
function template_settings()
{
    ...
    echo '
			...
			<tr class="windowbg2">
				...
				<td><input type="checkbox" name="smiley_sets_enable" id="smiley_sets_enable"', empty($modSettings['smiley_sets_enable']) ? '' : ' checked', ' class="check"></td>
				...
				<td><input type="checkbox" name="smiley_enable" id="smiley_enable"', empty($modSettings['smiley_enable']) ? '' : ' checked', ' class="check"></td>
			...
			<tr class="windowbg2">
				...
				<td><input type="checkbox" name="messageIcons_enable" id="messageIcons_enable"', empty($modSettings['messageIcons_enable']) ? '' : ' checked', ' class="check"></td>
			</tr><tr class="windowbg2">
    ...
    foreach ($context['smiley_sets'] as $smiley_set) {
        echo '
			<tr class="windowbg2">
				...
				<td>', 0 != $smiley_set['id'] ? '<input type="checkbox" name="smiley_set[' . $smiley_set['id'] . ']" value="1" class="check">' : '', '</td>
			</tr>';
    }
...
function template_modifyset()
{
        ...
        echo '
			<tr class="windowbg">
				<td align="left" colspan="2">
					<span class="smalltext">', 1
                                               == $context['current_set']['can_import'] ? $txt['smiley_set_import_single'] : $txt['smiley_set_import_multiple'], ' <a href="', $scripturl, '?action=smileys;sa=import;set=', $context['current_set']['id'], ';sesc=', $context['session_id'], '">', $txt['662'], '</a> ', 1
                                                                                                                                                                                                                                                                                      == $context['current_set']['can_import'] ? $txt['smiley_set_to_import_single'] : $txt['smiley_set_to_import_multiple'], '</span>
				</td>
			</tr>';
    }
    ...
    if ('default' == $context['current_set']['id']) {
    ...
    echo '/..
			...
			<tr class="windowbg2">
				...
				<td><input type="checkbox" name="smiley_sets_default" value="1"', $context['current_set']['selected'] ? ' checked' : '', ' class="check"></td>
			</tr>';
...
function template_editsmileys()
{
    ...
    echo '
				...
				<td></td>
				<td>
					', 'code' == $context['sort'] ? '<b>' . $txt['smileys_code'] . '</b>' : '<a href="' . $scripturl . '?action=smileys;sa=editsmileys;sort=code">' . $txt['smileys_code'] . '</a>', '
				</td><td>
					', 'filename' == $context['sort'] ? '<b>' . $txt['smileys_filename'] . '</b>' : '<a href="' . $scripturl . '?action=smileys;sa=editsmileys;sort=filename">' . $txt['smileys_filename'] . '</a>', '
				</td><td>
					', 'hidden' == $context['sort'] ? '<b>' . $txt['smileys_location'] . '</b>' : '<a href="' . $scripturl . '?action=smileys;sa=editsmileys;sort=hidden">' . $txt['smileys_location'] . '</a>', '
				</td><td>
					', 'description' == $context['sort'] ? '<b>' . $txt['smileys_description'] . '</b>' : '<a href="' . $scripturl . '?action=smileys;sa=editsmileys;sort=description">' . $txt['smileys_description'] . '</a>', '
				</td><td>
					', $txt['smileys_modify'], '
				</td>
				<td width="4%"></td>
			...
			<tr class="windowbg2">
				...
				<td>
					<select name="smiley_location">
						<option value="0"', 0 == $context['current_smiley']['location'] ? ' selected="selected"' : '', '>
							', $txt['smileys_location_form'], '
						</option>
						<option value="1"', 1 == $context['current_smiley']['location'] ? ' selected="selected"' : '', '>
							', $txt['smileys_location_hidden'], '
						</option>
						<option value="2"', 2 == $context['current_smiley']['location'] ? ' selected="selected"' : '', '>
...
function template_addsmiley()
{
	...
	<form action="', $scripturl, '?action=smileys;sa=addsmiley" method="post" accept-charset="', $context['character_set'], '" name="smileyForm" id="smileyForm" enctype="multipart/form-data">
		<table border="0" cellspacing="0" cellpadding="4" align="center" width="80%" class="tborder">
			...
			<tr class="windowbg">
				<td width="40%"><label for="method-existing"><input type="radio" name="method" id="method-existing" value="existing" checked class="check"> ', $txt['smileys_add_existing'], '</label></td>
				<td>
    ...
    echo '
			...
			<tr class="windowbg2">
				...
				<td width="60%"><input type="checkbox" name="sameall" id="sameall" checked class="check" onclick="swapUploads(); selectMethod(\'upload\');"></td>
			</tr>
