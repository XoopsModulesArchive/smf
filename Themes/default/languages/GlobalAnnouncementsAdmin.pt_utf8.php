...
$txt['ga_boards_desc'] = 'You may select more that one board. To select boards hold down Shift or Ctrl. If you want to show on all boards, select "<i>All Boards</i>" <b>ONLY</b>.';
