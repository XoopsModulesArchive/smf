...
$txt['mboards_groups_desc'] = 'Groups allowed to access this board.<br><i>Note: if the member is any group or post group checked, they will have access to this board.</i>';
