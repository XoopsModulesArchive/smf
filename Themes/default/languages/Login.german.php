...
$txt['register_immediate_message'] = 'Sie sind jetzt mit einem Benutzerkonto im '
                                     . $context['forum_name']
                                     . ' registriert, %1$s!'
                                     . "\n\n"
                                     ...
                                     . "\n\n"
                                     . $txt[130];
$txt['register_activate_message'] = 'Sie sind jetzt mit einem Benutzerkonto im '
                                     . $context['forum_name']
                                     . ' registriert, %1$s!'
                                     . "\n\n"
                                     ...
                                     . "\n\n"
                                     . $txt[130];
$txt['register_pending_message'] = 'Ihre Registrierung im '
                                     . $context['forum_name']
                                     . ' haben wir erhalten, %1$s.'
                                     . "\n\n"
...
$txt['resend_activate_message'] = 'Sie sind jetzt mit einem Benutzerkonto im '
                                  . $context['forum_name']
                                  . ' registriert, %1$s!'
                                  . "\n\n"
                                  ...
                                  . "\n\n"
                                  . $txt[130];
$txt['resend_pending_message'] = 'Ihre Registrierung im '
                                  . $context['forum_name']
                                  . ' haben wir erhalten, %1$s.'
                                  . "\n\n"
...
$txt['coppa_after_registration'] = 'Du hast Dich im '
                                    . $context['forum_name']
                                    . ' registriert.<br><br>Du f&#228;llst als Benutzer unter die Altergrenze von {MINIMUM_AGE}. Daher ist eine Genehmigung von Deinen Eltern/Erziehungsberechtigten erforderlich, welche Dir erlaubt das Benutzerkonto zu benutzen. Um das Benutzerkonto aktivieren zu lassen, drucke bitte folgendes Formular aus:';
...
$txt['coppa_form_body'] = 'Ich, {PARENT_NAME},<br><br>erlaube {CHILD_NAME} (Name des Kindes) ein registrierter Benutzer des Forums '
                             . $context['forum_name']
                             . ' mit dem Benutzernamen {USER_NAME} zu werden.<br><br>Ich bin damit einverstanden, dass bestimmte pers&#246;nliche Angaben von {USER_NAME} auch von anderen Benutzern im Forum einsehbar sind.<br><br>Unterschrift:<br>{PARENT_NAME} (Eltern/Erziehungsberechtigte).';
