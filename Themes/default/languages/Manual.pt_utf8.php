...
$txt['manual_index_home_desc_part1'] = '<b>Home</b>, which takes you back to the ';
$txt['manual_index_home_desc_link_board'] = 'board index';
$txt['manual_index_home_desc_part2'] = '.';
$txt['manual_index_help_desc'] = '<b>Help</b>, which brings you to this guide.';
$txt['manual_index_search_desc_part1'] = '<b>Search</b>, which allows you to ';
...
$txt['manual_index_home_reg'] = '<b>Home</b> (as before).';
$txt['manual_index_help_reg'] = '<b>Help</b> (as before).';
$txt['manual_index_search_reg'] = '<b>Search</b> (as before).';
$txt['manual_index_profile_reg_part1'] = '<b>Profile</b>, which allows you to make changes to your ';
$txt['manual_index_profile_reg_link_profile'] = 'profile';
$txt['manual_index_profile_reg_part2'] = ' settings.';
$txt['manual_index_calendar_reg'] = '<b>Calendar</b> (as before).';
$txt['manual_index_logout_reg_part1'] = '<b>Logout</b>, which allows you to ';
$txt['manual_index_logout_reg_link_loginout_logout'] = 'logout';
$txt['manual_index_logout_reg_part2'] = ' again if desired.';
$txt['manual_index_forum_admins_note_presentation'] = 'Forum administrators should also note the presence of an additional <b>Admin</b> button.';
...
$txt['manual_index_f_name'] = 'The <b>forum name</b> links back to the top of the board index.';
$txt['manual_index_cat'] = 'If the <b>category</b> is collapsible (shown by the little arrow symbol), clicking the category name collapses or expands the category as appropriate.';
$txt['manual_index_b_name_part1'] = 'The <b>board name</b> links to the ';
$txt['manual_index_b_name_link_message'] = 'message index';
$txt['manual_index_b_name_part2'] = ' for that board.';
$txt['manual_index_b_desc'] = 'The <b>board description</b> describes the board\'s content, and may also include links to child boards and/or specify the board\'s moderator(s).';
$txt['manual_index_n_no_n_posts'] = 'The <b>New Posts</b> and <b>No New Posts</b> icons in the leftmost column show registered members whether there have been any new posts to the board since they last read it.';
$txt['manual_index_m_read'] = 'The <b>Mark as Read</b> button enables registered members to mark all posts in the entire forum as \'read\'.';
...
$txt['manual_index_nav_tree'] = 'Some forums show the <b>navigation tree</b> at the top in a space-saving horizontal mode.';
$txt['manual_index_page_number'] = 'The <b>page numbers</b> link to further pages of the board, and may be accompanied by <b>Go Up</b> and <b>Go Down</b> buttons linking to the top and bottom of the current page.';
$txt['manual_index_mark_read_button'] = 'The <b>Mark as Read</b> button enables registered members to mark all posts in this board as \'read\'.';
$txt['manual_index_notify_button'] = 'The <b>Notify</b> button enables registered members to subscribe to email notification of replies to topics in this board.';
$txt['manual_index_new_topic_poll_button_part1'] = 'The <b>New Topic</b> and <b>New Poll</b> buttons are for starting new topics and polls, as described in the ';
$txt['manual_index_new_topic_poll_button_link_posting'] = 'posting help';
$txt['manual_index_new_topic_poll_button_part2'] = '.';
$txt['manual_index_subject_replies_etc'] = 'The <b>Subject</b>, <b>Started by</b>, <b>Replies</b>, <b>Views</b> and <b>Last post</b> links enable you to sort the columns by these parameters (with <b>Last post</b> also toggling between descending and ascending order as indicated by the little arrow).';
$txt['manual_index_topic_icons'] = 'The <b>topic icons</b> in the leftmost column are explained by the key below.';
$txt['manual_index_post_icons'] = 'The <b>post icons</b> in the next column are sometimes used to draw attention to the mood or purpose of the topic.';
$txt['manual_index_topic_subject_links_part1'] = 'The <b>topic subject</b> links to the start of the ';
$txt['manual_index_topic_subject_links_link_topic'] = 'topic';
$txt['manual_index_topic_subject_links_part2'] = ', with extra links for subsequent pages and <b>new</b> buttons to take registered members straight to their first unread post of the topic.';
$txt['manual_index_where_topic_part1'] = 'Where the <b>topic</b> has been started or last replied to by a registered member, their names link to their respective ';
$txt['manual_index_where_topic_link_profile'] = 'profiles';
$txt['manual_index_where_topic_part2'] = '.';
$txt['manual_index_jump_to_menu'] = 'The <b>Jump to</b> menu provides a convenient quick method of navigating the forum.';
$txt['manual_index_sec_topic'] = 'The Topic';
$txt['manual_index_ref_thread'] = 'Sometimes referred to as <b>threads</b>, <b>topics</b> are where you find the actual messages:';
...
$txt['manual_index_navigation_tree'] = 'Some forums show the <b>navigation tree</b> at the top in a space-saving horizontal mode.';
$txt['manual_index_prev_next'] = 'Some forums may also be configured with <b>previous</b> and <b>next</b> topic links.';
$txt['manual_index_page_no_link'] = 'The <b>page numbers</b> link to further pages of the topic, and may be accompanied by <b>Go Up</b> and <b>Go Down</b> buttons linking to the top and bottom of the current page.';
$txt['manual_index_reply_button_part1'] = 'The <b>Reply</b> button enables you to ';
$txt['manual_index_reply_button_link_posting_reply'] = 'reply';
$txt['manual_index_reply_button_part2'] = ' to the topic.';
$txt['manual_index_notify_button_enables'] = 'The <b>Notify</b> button enables registered members to subscribe to email notification of replies to the topic.';
$txt['manual_index_mark_unread_button'] = 'The <b>Mark Unread</b> button enables registered members to mark the topic as \'unread\', which means that it will still be listed as new and can be effectively \'saved for later\'. Note that this button changes to <b>Add Poll</b> in the bottom button set for users with permission to add polls to existing topics.';
$txt['manual_index_send_topic_button'] = 'The <b>Send Topic</b> button enables registered members to send a link to the topic by email.';
$txt['manual_index_print_button'] = 'The <b>Print</b> button creates a simplified, printer-friendly rendering of the page.';
$txt['manual_index_author_name_link_part1'] = 'The <b>author name</b> links to the author\'s ';
$txt['manual_index_author_name_link_link_profile'] = 'profile';
$txt['manual_index_author_details'] = 'The <b>author details</b> in the lefthand column may be accompanied by further personal information.';
$txt['manual_index_topic_subject_links_start'] = 'The <b>topic subject</b> links back to the start of the topic.';
$txt['manual_index_quote_button_part1'] = 'The <b>Quote</b> button enables you to ';
$txt['manual_index_quote_button_link_posting_quote'] = 'quote';
$txt['manual_index_quote_button_part2'] = ' the post.';
$txt['manual_index_modify_delete_part1'] = 'Further <b>Modify</b> and <b>Delete</b> options are normally provided to enable registered members to ';
$txt['manual_index_modify_delete_link_posting_modify'] = 'edit';
$txt['manual_index_modify_delete_part2'] = ' their own posts.';
$txt['manual_index_report_to_moderator'] = '<b>Report to moderator</b> enables you to report abusive or wrongly-placed posts to the forum staff.';
$txt['manual_index_logged_IP'] = '<b>Logged</b> indicates that the IP of the author has been logged. The actual IP is only available to board administrators';
$txt['manual_index_jump_to_menu_provides'] = 'The <b>Jump to</b> menu provides a convenient quick method of navigating the forum.';
...
$txt['manual_loginout_login_screen_desc_part1'] = 'Since this screen (accessed from the <b>Login</b> option of the ';
...
$txt['manual_loginout_login_screen_explanation'] = 'While the <b>Username</b> and <b>Password</b> fields should be self-explanatory, <b>Minutes to stay logged in</b> simply means the number of minutes the cookie that keeps you logged in will last before expiring and requiring you to login again. So it\'s not advisable to enter a long time here if you share a computer and are likely to forget to logout, but you might prefer to check <b>Always stay logged in</b> if no-one else has access to your computer.';
...
$txt['manual_loginout_although_many_forums_part2'] = ') or you\'re already logged in (in which case the main menu should include a <b>Logout</b> rather than <b>Login</b> link!).';
...
$txt['manual_loginout_reminder_desc_part1'] = 'If you\'re trying to login to the forum but have forgetten or lost your password, you can retrieve it with the lost password tool by following the <b>Forgot your password?</b> link from the ';
...
$txt['manual_loginout_reminder_explanation'] = 'You can enter either your username or your email address so long as you check the appropriate option, then click the <b>Send</b> button to send yourself an email containing a link to reset your password. It\'s also possible to avoid the email altogether if you\'ve set yourself a secret question and answer in your profile, but please beware of questions that anyone could answer or guess (like \'what is the first color of the rainbow?\', which would be a very bad choice)!';
...
$txt['manual_pm_nav_tree'] = 'Some forums show the <b>navigation tree</b> at the top in a space-saving horizontal mode.';
$txt['manual_pm_delete_button'] = 'The main <b>Delete</b> button deletes all messages in your inbox (or outbox if open). Note that the checkbox and lower <b>Delete</b> button also allow you to delete selected messages, with the top checkbox selecting all.';
$txt['manual_pm_outbox_button'] = 'The <b>Outbox</b> button toggles to your outbox, where it obviously becomes an <b>Inbox</b> button.';
$txt['manual_pm_new_msg2_part1'] = 'The <b>New Message</b> button enables you to start a new message, which is similar to ';
...
$txt['manual_pm_reload'] = 'The <b>Reload</b> button checks for new messages by refreshing the page.';
$txt['manual_pm_sort_by'] = 'The <b>Date</b>, <b>Subject</b>, and <b>From</b> links enable you to sort the columns by these parameters (with <b>Date</b> also toggling between descending and ascending order as indicated by the little arrow).';
...
$txt['manual_pm_msg_link_part2'] = ', x are new\', then click the <b>New Message</b> button in your inbox.';
$txt['manual_pm_click_name_part1'] = 'You can click another member\'s name, followed by <b>Send this member a personal message</b> from his/her ';
$txt['manual_pm_click_name_link_profile_info-all'] = 'profile';
$txt['manual_pm_click_name_part2'] = ' summary screen.';
$txt['manual_pm_click_im_icon'] = 'You can start a new message direct by clicking the <b>IM on/offline</b> icon from the user info accompanying all of his/her posts.';
$txt['manual_pm_click_pm_icon_part1'] = 'You can start a new message direct by clicking the <b>PM on/offline</b> icon from the <b>Current Status</b> in his/her ';
...
$txt['manual_posting_please_note'] = '<b>Please note that, because an SMF forum may be customized extensively by its administrator(s), the presence of a feature in this documentation does not necessarily mean that it will be available to all users in all forums.</b>';
$txt['manual_posting_sec_posting_basics'] = 'Posting Basics';
$txt['manual_posting_starting_topic'] = 'Starting a New Topic';
$txt['manual_posting_starting_topic_desc_part1'] = 'Browse to the board where you wish to post and click the <b>New Topic</b> button (positioned by default at both the top and the bottom of the board, as shown in the ';
$txt['manual_posting_starting_topic_desc_link_index_message'] = 'User Help Introduction';
$txt['manual_posting_starting_topic_desc_part2'] = '), which should take you to the <b>Start new topic</b> screen. While this presents a number of options, the two most important are the <b>Subject</b> field and main <b>Message</b> field (not labeled as such, but obvious by its size). So enter your subject and start to type (or paste) your message into the main text area, noting that a message missing either a subject or a body will not be accepted for posting until it has both. If you\'re happy with your plain text message, you can then post it by clicking the <b>Post</b> button and/or preview it first by clicking the <b>Preview</b> button, but there are many further ';
...
$txt['manual_posting_nav_tree'] = 'Some forums show the <b>navigation tree</b> at the top in a space-saving horizontal mode.';
$txt['manual_posting_spell_check'] = 'Some forums may be configured to offer an additional <b>Spell Check</b> button alongside the <b>Post</b> and <b>Preview</b> options.';
$txt['manual_posting_start_poll'] = 'Starting a New Poll';
$txt['manual_posting_poll_desc_part1'] = 'A poll is basically a topic with an added question and voting options, started by clicking <b>New Poll</b> instead of <b>New Topic</b> ';
$txt['manual_posting_poll_desc_link_newtopic'] = 'as described above';
$txt['manual_posting_poll_desc_part2'] = '. To post a poll it is necessary to fill out the <b>Question</b> field and at least two of the <b>Option</b> fields in addition to the <b>Subject</b> and <b>Message</b> fields required by a standard topic. Further options to configure how many choices the user may vote for, how long the poll should run, whether users can change their votes and what conditions must be fulfilled for the results to be displayed should be self-explanatory.';
$txt['manual_posting_poll_options'] = 'To offer more than five choices in a poll, simply click <b>Add Option</b> as many times as necessary.';
...
$txt['manual_posting_event_desc_part1'] = 'Where this option has been configured (it\'s not standard \'out of the box\'), you can post an event by selecting <b>Calendar</b> from the ';
$txt['manual_posting_event_desc_link_index_main'] = 'main menu';
$txt['manual_posting_event_desc_part2'] = ' followed by <b>Post Event</b> from the calendar screen. What you see now is a <b>Start new topic</b> screen with supplementary fields for the event title, date and target board, which simply add your event to the calendar and create a link back to your post in that board.';
...
$txt['manual_posting_replying_desc_part2'] = ', but it\'s not necessary to enter anything in the <b>Subject</b> field unless you wish to change what\'s already there. To vote in a poll, you simply have to select your chosen option(s) and click <b>Submit Vote</b>.';
...
$txt['manual_posting_quote_desc'] = 'To reply to a post by quoting it, you can either click the <b>Quote</b> button for the relevant post and add your own message to the quoted text or click the <b>Reply</b> button followed by <b>Insert Quote</b> from the relevant post in the \'Topic Summary\' below, but note that:';
...
$txt['manual_posting_quote_both_part2'] = ' <b>quote</b> tag simply quotes the relevant post without this additional information.';
$txt['manual_posting_quote_independant_part1'] = 'You can also retain or add the \'author\' attribute independently of the full <b>Quote</b> function, as demonstrated in the ';
...
$txt['manual_posting_modify_desc'] = 'To modify a post, click the <b>Modify</b> button and make your changes. Note that most forums are likely to be configured to show the date and time of the last edit, but the administrator(s) may also allow a short period to elapse before this happens.';
$txt['manual_posting_delete_desc'] = 'To delete a post, click the <b>Delete</b> button followed by <b>OK</b> from the <b>Remove this message?</b> box that appears. Some forums may also allow you to remove topics or polls that you start, but the buttons for these are usually at the bottom of the page.';
...
$txt['manual_posting_bbc_desc'] = 'Bulletin Board Code (or BBC) is the essential tool for formatting and changing the appearance of your post. While it affects the plain text in much the same way as the formatting tools in any word processor, the main <b>Message</b> field does not behave in a WYSIWYG manner, so you should preview your message if you need to see what it will look like when posted.';
...
$txt['manual_posting_tags_desc_part2'] = ' and their purposes, let\'s see how they work by imagining that we want to post some text in bold type. While we can start by clicking the <b>B</b> (Bold) button and typing our text between the tags it produces, it\'s often more practical to type the text first, highlight it and then click the button. So typing \'text\', highlighting it and clicking the \'B\' button should produce \'[b]text[/b]\', which renders as <b>text</b> when posted or previewed. (NB This doesn\'t work in Opera, which inserts the tags at the end of the post.) Subsequently highlighting \'[b]text[/b]\' and clicking the <b>I</b> (Italicized) button will produce \'[i][b]text[/b][/i]\', which not only renders as <i><b>text</b></i> when posted or previewed but also introduces the concept of nesting, which means that each new set of tags in a case like this should be seen as a new \'box\' containing both the original text <i>and</i> any tags already applied to it.';
...
$txt['manual_posting_attach_desc_part1'] = 'If enabled, this feature allows you to attach files to your posts in much the same way as most email clients, so you simply have to browse to the relevant file(s) on your computer before clicking <b>Post</b>. You can delete your attachment(s) or add more by ';
...
$txt['manual_posting_most_forums_attach'] = 'Although most forums are likely be configured to display attached images as part of the post, it\'s not possible to <i>preview</i> attachments so you should always browse to and attach your files just before you finally <i>post</i> your message.';
...
$txt['manual_profile_edit_profile_part1'] = 'To edit your own profile, start by selecting <b>Profile</b> from the ';
...
$txt['manual_profile_summary_part1'] = 'This <b>Summary</b> screen is not only there to tell you about others, but also the first screen that you see when ';
$txt['manual_profile_summary_link_owners'] = 'editing your own profile';
$txt['manual_profile_summary_part2'] = '.';
$txt['manual_profile_hide_email'] = 'Members may choose to hide their <b>email address</b> and/or <b>online status</b>.';
...
$txt['manual_profile_send_member_pm_part2'] = ' by clicking the <b>Current Status</b> <b>On/Offline Icon</b> or following the link from <b>Additional Information</b> below.';
$txt['manual_profile_show_last_posts'] = '<b>Show the last posts of this person</b> links to a complete paginated listing of the member\'s posts.';
$txt['manual_profile_show_member_stats2'] = '<b>Show general statistics for this member</b> links to a screen of statistics about the member\'s time online and posting activity.';
$txt['manual_profile_sec_normal'] = 'Settings Normally Available to Profile Owners';
$txt['manual_profile_normal_desc'] = 'While the <b>Summary</b> screen is the same as the one shown above and the <b>Show Posts</b> and <b>Show Stats</b> links are effectively duplicates, profile owners are also provided with the tools to customize their own profiles:';
$txt['manual_profile_modify_profile'] = 'Modify Profile';
$txt['manual_profile_account_related'] = '<b>Account Related Settings</b> enables you to make changes to your <b>display name</b> (your <b>login</b> or <b>username</b> can only be changed by an administrator), preferred <b>language</b> (if the forum administrators have installed alternative language packs), <b>email</b> and <b>password</b> settings.';
$txt['manual_profile_forum_profile_info'] = '<b>Forum Profile Information</b> enables you to enter optional personal details such as <b>gender</b>, <b>birthdate</b>, <b>location</b>, <b>website</b> and <b>instant messenger</b> contact information. It\'s also where you go to enter your own <b>personal text</b> and <b>signature</b> and select an <b>avatar</b> (personal picture) from a list (if provided by the forum administrators) or link to one of your own on the web.';
$txt['manual_profile_look_layout'] = '<b>Look and Layout Preferences</b> enables you to select your preferred <b>theme</b> (forum skin), time zone and format and other personal choices for <b>layout settings</b>. Note that the currently selected option in the menu pane is highlighted in bold type:';
...
$txt['manual_profile_notify_email_prefs'] = '<b>Notifications and Email</b> enables you to select personal preferences for <b>notifications</b> (emails about new topics/replies) and lists any notifications that you have set up.';
$txt['manual_profile_pm_options_part1'] = '<b>Personal Message Options</b> enables you to set up an <b>ignore list</b> (blacklist) for ';
$txt['manual_profile_pm_options_link_pm'] = 'Personal Messages';
$txt['manual_profile_pm_options_part2'] = ', to request <b>notification</b> of new PMs by email and to <b>save copies</b> of your outgoing PMs by default.';
$txt['manual_profile_sub_actions'] = 'Actions';
$txt['manual_profile_confirm_delete_acct'] = '<b>Delete this account</b> does exactly what it says! Yes, there\'s a <b>confirmation screen</b>, but it really does <b>delete your own account</b>, so be careful...';
...
$txt['manual_profile_sub_track_user'] = '<b>Track User</b> provides a list of <b>IP numbers</b> used by the member, other members who might be in the same <b>IP range</b> and <b>error messages</b> generated/experienced by the member.';
$txt['manual_profile_sub_track_ip'] = '<b>Track IP</b> provides tools for tracking <b>members</b>, <b>messages</b> and <b>errors</b> from any specified <b>IP range</b>.';
$txt['manual_profile_sub_show_permissions'] = '<b>Show Permissions</b> lists the <b>board permissions</b> that have been granted to the member and who gave them.';
$txt['manual_profile_sub_modify_profile'] = 'Modify Profile';
$txt['manual_profile_sub_acct_settings'] = '<b>Account Related Settings</b> is basically the same screen as shown to profile owners, but with the additional option to assign members to <b>member groups</b>.';
$txt['manual_profile_sub_forum_profile_info'] = '<b>Forum Profile Information</b> is basically the same screen as shown to profile owners, but with the additional option to specify <b>custom titles</b> for members.';
$txt['manual_profile_sub_actions2'] = 'Actions';
$txt['manual_profile_sub_ban_user'] = '<b>Ban this user</b> provides tools for <b>banning</b> users, configuring the <b>level</b> of the ban and maintaining a <b>ban list</b> noting the details of any bans in force.';
$txt['manual_profile_sub_delete_acct'] = '<b>Delete this account</b> is similar to the screen of the same name available to all members, but the <b>confirmation question</b> is different when it\'s not your own account that\'s about to be deleted.';
...
$txt['manual_registering_select_register_part1'] = 'Any page of the forum, in which you case you should select <b>Register</b> from the ';
$txt['manual_registering_select_register_link_index_main'] = 'main menu';
$txt['manual_registering_select_register_part2'] = '.';
$txt['manual_registering_login_Scr_part1'] = 'A login screen headed by a warning about access being restricted to registered members, in which case you should either use the registration link provided or select <b>Register</b> from the ';
...
$txt['manual_registering_reg_screen_requirements_part1'] = 'When you arrive at the registration screen, you will need to enter a <b>username</b>, <b>email address</b> and <b>password</b>, and may be offered the option of hiding your email address. Since most forums also require you to agree to their terms of use before your registration is accepted, you will normally have to read the agreement and check <b>I Agree</b> before continuing. What happens next depends on how the forum is configured, but, if the next thing you see is a ';
...
$txt['manual_registering_email_activate'] = 'If registration has been configured to require email activation, the next screen will tell you so and you should receive an immediate email with instructions about how to proceed. But there\'s also a useful link (\'Did you miss your activation email?\') in the <b>User Info</b> box in case you miss this email or mistype your email address.';
...
$txt['manual_searching_search_desc_part1'] = 'Assuming the forum is running the SMF default theme (or a derivative of it), there should be both a simple <b>Search</b> field (partnered by an <b>Advanced search</b> text link) in the collapsible top section and a <b>Search</b> option in the ';
$txt['manual_searching_search_desc_link_index_main'] = 'main menu';
$txt['manual_searching_search_desc_part2'] = '. If not, the main menu <b>Search</b> option should still lead straight to the advanced search screen.';
...
$txt['manual_searching_quotes_desc'] = 'To put this in a nutshell, searching for <b>simple machines forum</b> will return any or all of these three words, but enclosing the search string in <i>double</i> quote marks (ie <b>"simple machines forum"</b>) will return only the entire phrase.';
...
$txt['manual_searching_nav_tree'] = 'Some forums show the <b>navigation tree</b> at the top in a space-saving horizontal mode.';
$txt['manual_searching_three_options_part1'] = 'Despite initial appearances, there are really <i>three</i> options for how to search, with <b>Match all words</b> and <b>Match any words</b> being available from the drop-down, and <b>"Match as phrase"</b><!-- and <b>*wildcards</b> --> still being available as ';
$txt['manual_searching_three_options_link_syntax'] = 'described';
$txt['manual_searching_three_options_part2'] = ' above.';
$txt['manual_searching_wildcard'] = 'The default * in the <b>by user</b> field is essentially a wildcard matching any poster. Please note that, while you can replace this with any <i>single</i> username for a more specific search, it\'s not currently possible to search for posts by multiple users except as that single wildcard.';
$txt['manual_searching_results_as_messages'] = '<b>Show results as messages</b> returns the full message containing the search string (with a reply option) instead of the usual linked excerpt, but will naturally result in much larger results pages which might be significant if you are searching for a popular word or phrase.';
$txt['manual_searching_message_age'] = '<b>Message age</b> sets the minimum and maximum ages of posts to search.';
$txt['manual_searching_which_board'] = '<b>Choose a board to search in</b> provides you with another tool to narrow the scope of the search, with the default being \'all\' (the whole forum or, more properly, all the boards to which you have read access).';
$txt['manual_searching_search_button'] = 'The <b>Search</b> button not surprisingly sets the whole thing in motion, but hitting \'Enter\' direct from any of the search fields is sometimes more convenient.';
