...
$txt[80] = 'Sie haben keine Berechtigung, dieses Profil zu &#228;ndern.';
$txt[83] = 'Titel der Webseite';
$txt[84] = 'URL der Webseite';
$txt[85] = 'Signatur';
$txt[86] = 'Beitr&#228;ge';
$txt[88] = 'Profil &#228;ndern';
$txt[89] = 'Benutzer l&#246;schen';
$txt[113] = 'Dieses Mitglied ist:';
$txt[228] = 'Pers&#246;nlicher Text';
$txt[229] = 'Benutzerbild';
$txt[232] = 'Bild/Text';
$txt[329] = 'Eingabe l&#246;schen';
...
$txt[597] = 'Zus&#228;tzliche Information';
$txt[598] = 'Bitte ausf&#252;llen, wenn Sie unten eine URL eingeben!';
$txt[599] = 'Bitte eine komplette URL (inkl. http://) angeben - (http://www.meineseite.de).';
...
$txt[664] = 'Max. ' . $modSettings['max_signatureLength'] . ' Zeichen - &#252;brig: ';
$txt[688] = 'Diesem Mitglied eine Private Mitteilung senden';
$txt[722] = 'versteckt';
$txt[741] = 'Aktuelle Zeit des Forums';
$txt[749] = 'Die \'Beitr&#228;ge\' Box kann nur Zahlen enthalten.';

$txt['smf225'] = 'Sprache';
$txt['smf227'] = 'Das Benutzerbild ist zu gro&#223;. Bitte verkleinern Sie es und versuchen Sie es erneut (max';
$txt['smf233'] = 'Ung&#252;ltiges Registrierungsdatum, g&#252;ltiges Beispiel:';
$txt['smf237'] = 'Ihre MSN E-Mail Adresse';
$txt['smf241'] = 'Aktuelles Passwort';
$txt['smf243'] = 'Sie haben das Passwort nicht eingegeben. Um &#196;nderungen an Ihrem Profil vorzunehmen, m&#252;ssen Sie das aktuelle Passwort unbedingt eingeben.';
// Don't use entities in the below string, except the main ones. (lt, gt, quot.)
$txt['smf244'] = 'Aus Sicherheitsgründen muss bei jeder Änderung der Benutzerkonto-Einstellungen das aktuelle Passwort eingegeben werden.';
...
$txt['pswd2'] = 'Antwort';
$txt['pswd3'] = 'Stellen Sie mir die geheime Frage';
$txt['pswd4'] = 'Sie haben keine M&#246;glichkeit, Ihr Passwort abzufragen! Sie k&#246;nnen aber ein neues festlegen, indem Sie dem Link folgen, welcher Ihnen per E-Mail zugeschickt werden kann. Beantworten Sie Ihre geheime Frage, k&#246;nnen Sie gleich ein neues Passwort festlegen.';
$txt['pswd5'] = 'Sie haben keine g&#252;ltige Kombination von Geheimfrage und -antwort im Benutzerprofil angegeben. Bitte klicken Sie auf den \'Zur&#252;ck\' Button und benutzen Sie die Standardmethode, um Ihr Passwort zu erlangen.';
$txt['pswd6'] = 'Bitte geben Sie die Antwort auf Ihre geheime Frage und das gew&#252;nschte Passwort ein. Ihr Passwort wird danach ge&#228;ndert - vorausgesetzt, Sie haben die Frage richtig beantwortet.';
$txt['pswd8'] = 'Ihr Passwort wurde erfolgreich ge&#228;ndert.<br>Klicken Sie <a href="' . $scripturl . '?action=login">hier</a> zum einloggen.';
$txt['secret_why_blank'] = 'Warum ist dieses Feld leer?';

$txt['theme1a'] = 'Ausgew&#228;hltes Theme';
$txt['theme1b'] = '(&#228;ndern)';
...
$txt['notifyXAnn4'] = 'E-Mail Benachrichtigung bei neuen Ank&#252;ndigungen schicken';
$txt['notifyXOnce1'] = 'Ich m&#246;chte nur zur 1. ungelesenen Antwort eine E-Mail Benachrichtigung';
...
$txt[326] = 'F&#252;gen Sie einen Benutzername pro Zeile hinzu oder geben Sie * ein, um alle Mitteilungen zu ignorieren.';
...
$txt['statPanel_total_posts'] = 'Beitr&#228;ge insgesamt';
$txt['statPanel_total_topics'] = 'Beitr&#228;ge gestartet';
...
$txt['statPanel_show'] = 'Statistiken f&#252;r diesen Benutzer anzeigen';
...
$txt['deleteAccount_member'] = 'L&#246;sche das Benutzerkonto des Mitglieds';
...
$txt['trackIP'] = 'IP beobachten';

$txt['profileEdit'] = 'Profil-Einstellungen';
$txt['account'] = 'Benutzerkonto';
$txt['account_info'] = 'Hier k&#246;nnen Sie alle wichtigen Informationen &#228;ndern, die Sie im Forum identifizieren. Aus Sicherheitsgr&#252;nden m&#252;ssen Sie Ihr Passwort eingeben, wenn Sie diese Angaben ver&#228;ndern m&#246;chten.';
$txt['forumProfile'] = 'Profil';
$txt['forumProfile_info'] = 'Hier k&#246;nnen Sie Ihre pers&#246;nlichen Informationen &#228;ndern, welche &#252;berall im Forum angezeigt werden. Wenn Sie Informationen nicht angeben m&#246;chten, k&#246;nnen Sie diese &#252;berspringen.';
$txt['theme'] = 'Design &amp; Layout';
$txt['theme_info'] = 'Hier k&#246;nnen Sie das Design und das Layout des Forums zu &#228;ndern.';
$txt['notification'] = 'Benachrichtigungen &amp; E-Mail';
$txt['notification_info'] = 'Hier k&#246;nnen Sie die abonnierten Themen/Boards anschauen und die Einstellungen &#228;ndern.';
$txt['pmprefs'] = 'Private Mitteilungen';
$txt['pmprefs_info'] = 'Hier k&#246;nnen Sie bestimmte oder alle Privaten Mitteilungen blockieren bzw. weitere Einstellungen vornehmen.';
...
$txt['invalid_ip'] = 'Ung&#252;ltige IP-Adresse. Beachten Sie dass nur (*) als Maske erlaubt sind, z.B. 127.0.*.*';
$txt['ip_address'] = 'IP-Adresse';
$txt['ips_in_errors'] = 'Benutzte IPs in Fehlermeldungen';
$txt['ips_in_messages'] = 'Benutzte IPs in Beitr&#228;gen';
...
$txt['activate_changed_email'] = 'Sie haben Ihre E-Mail Adresse ge&#228;ndert. Um sie zu best&#228;tigen, erhalten Sie eine E-Mail mit einem Link auf den Sie klicken sollten, damit das Benutzerkonto wieder aktiviert wird.';

$txt[394] = 'Senden der Erinnerungs E-Mail nicht m&#246;glich.';
...
$txt['reminder_error'] = '%s hat die geheime Frage (w&#228;hrend des Versuches ein vergessenes Passwort zu &#228;ndern) nicht richtig beantwortet.';
...
$txt['show_online'] = 'Online Status anzeigen?';
...
$txt['timeformat_easy2'] = 'Monat Tag, Jahr, HH:MM:SS (Milit&#228;rzeit)';
...
$txt[732] = 'Boardbeschreibung innerhalb der Boards anzeigen?';
...
$txt['buddy_add'] = 'Zur Buddy-Liste hinzuf&#252;gen';
