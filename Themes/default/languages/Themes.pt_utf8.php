...
$txt['themeadmin_reset_options_info'] = 'The options below will reset options for <i>everyone</i>. To change an option, select &quot;change&quot; in the box next to it, and then select a value for it. To use the default, select &quot;remove&quot;. Otherwise, use &quot;don\'t change&quot; to keep it as-is.';
...
$txt['themeadmin_edit_no_copy'] = '<i>(can\'t copy)</i>';
