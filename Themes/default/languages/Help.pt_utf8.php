...
$helptxt['enableAllMessages'] = 'Set this to the <i>maximum</i> number of posts a topic can have to show the all link. Setting this lower than &quot;Maximum messages to display in a topic page&quot; will simply mean it never gets shown, and setting it too high could slow down your forum.';
...
$helptxt['queryless_urls'] = 'This changes the format of URLs a little so search engines will like them better. They will look like index.php/topic,1.html.<br><br>This feature will ' . (false !== mb_strpos(php_sapi_name(), 'apache') ? '' : 'not') . ' work on your server.';
...
$helptxt['permissions_postgroups'] = 'Enabling permissions for post count based groups will allow you to attribute permissions to members that have posted a certain amount of messages. The permissions of the post count based groups are <i>added</i> to the permissions of the regular membergroups.';
...
$helptxt['membergroup_moderator'] = 'The Moderator membergroup is a special membergroup. Permissions and settings assigned to this group apply to moderators but only <i>on the boards they moderate</i>. Outside these boards they\'re just like any other member.';
