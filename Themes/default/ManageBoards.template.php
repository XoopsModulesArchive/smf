        ...
        foreach ($category['boards'] as $board) {
            ...
            echo '
							<tr class="windowbg', $alternate ? '' : '2', '">
								<td style="padding-left: ', 5 + 30 * $board['child_level'], 'px;', $board['move'] ? 'color: red;' : '', '">', $board['name'], !empty($modSettings['recycle_board']) && !empty($modSettings['recycle_enable'])
                                                                                                                                                              && $modSettings['recycle_board'] == $board['id'] ? '&nbsp;&nbsp;&nbsp;<a href="'
                                                                                                                                                                                                                 . $scripturl
                                                                                                                                                                                                                 . '?action=manageboards;sa=settings"><img src="'
                                                                                                                                                                                                                 . $settings['images_url']
                                                                                                                                                                                                                 . '/post/recycled.gif" alt="'
                                                                                                                                                                                                                 . $txt['recycle_board']
                                                                                                                                                                                                                 . '" border="0"></a>' : '', '</td>
								<td width="10%" align="right">', !empty($modSettings['permission_enable_by_board']) && $context['can_manage_permissions'] ? '<a href="'
                                                                                                                                                            . $scripturl
                                                                                                                                                            . '?action=permissions;sa=switch;to=local;boardid='
                                                                                                                                                            . $board['id']
                                                                                                                                                            . ';sesc='
                                                                                                                                                            . $context['session_id']
                                                                                                                                                            . '"'
                                                                                                                                                            . ($board['local_permissions'] ? '' : ' onclick="return confirm(\'' . $txt['mboards_permissions_confirm'] . '\');" style="font-style: italic;"')
                                                                                                                                                            . '>'
                                                                                                                                                            . $txt['mboards_permissions']
                                                                                                                                                            . '</a>' : '', '</td>
            ...
            if (!empty($board['move_links'])) {
                ...
                foreach ($board['move_links'] as $link) {
                    echo '<a href="', $link['href'], '" style="padding-right: 13px;padding-left: 0px;" title="', $link['label'], '"><img src="', $settings['images_url'], '/board_select_spot', $link['child_level']
                                                                                                                                                                                                > 0 ? '_child' : '', '.gif" alt="', $link['label'], '" border="0" style="padding: 0px; margin: 0px;"></a>';
                }
...
<form action="', $scripturl, '?action=manageboards;sa=cat2" method="post" accept-charset="', $context['character_set'], '">
    ...
    echo '
								...
								<td valign="top" align="right">
									<input type="checkbox" name="collapse"', $context['category']['can_collapse'] ? ' checked' : '', ' tabindex="2" class="check">
								</td>
							</tr>';
...
<form action="', $scripturl, '?action=manageboards;sa=cat2" method="post" accept-charset="', $context['character_set'], '">
	...
	<table width="600" cellpadding="4" cellspacing="0" border="0" align="center" class="tborder">
		...
		<tr>
			<td class="windowbg2">
				<label for="delete_action0"><input type="radio" id="delete_action0" name="delete_action" value="0" class="check" checked>', $txt['mboards_delete_option1'], '</label><br>
				<label for="delete_action1"><input type="radio" id="delete_action1" name="delete_action" value="1" class="check"', 1 == count($context['category_order']) ? ' disabled="disabled"' : '', '>', $txt['mboards_delete_option2'], '</label>:
				<select name="cat_to" ', 1 == count($context['category_order']) ? 'disabled="disabled"' : '', '>';
...
<form action="', $scripturl, '?action=manageboards;sa=board2" method="post" accept-charset="', $context['character_set'], '">
    ...
    foreach ($context['groups'] as $group) {
        echo '
									<label for="groups_', $group['id'], '"><span', $group['is_post_group'] ? ' style="border-bottom: 1px dotted;" title="'
                                                                                                             . $txt['mboards_groups_post_group']
                                                                                                             . '"' : '', '>', $group['name'], '</span> <input type="checkbox" name="groups[]" value="', $group['id'], '" id="groups_', $group['id'], '"', $group['checked'] ? ' checked' : '', '></label><br>';
    }
    ...
    if (empty($modSettings['permission_enable_by_board'])) {
        echo '
							<tr>
								...
								<td align="right">
									', $txt['permission_mode_normal'], ' <input type="radio" name="permission_mode" value="0" class="check"', 'normal' == $context['board']['permission_mode'] ? ' checked' : '', '><br>
									', $txt['permission_mode_no_polls'], ' <input type="radio" name="permission_mode" value="2" class="check"', 'no_polls' == $context['board']['permission_mode'] ? ' checked' : '', '><br>
									', $txt['permission_mode_reply_only'], ' <input type="radio" name="permission_mode" value="3" class="check"', 'reply_only' == $context['board']['permission_mode'] ? ' checked' : '', '><br>
									', $txt['permission_mode_read_only'], ' <input type="radio" name="permission_mode" value="4" class="check"', 'read_only' == $context['board']['permission_mode'] ? ' checked' : '', '><br>
									<br>
								</td>
							</tr>';
    }
    ...
    echo '
							<tr>
								...
								<td valign="top" align="right">
									<input type="checkbox" name="count" ', $context['board']['count_posts'] ? ' checked' : '', ' class="check">
								</td>
							</tr>';
							...
							<tr>
								...
								<td valign="top" align="right">
									<select name="boardtheme">
										<option value="0"', 0 == $context['board']['theme'] ? ' selected="selected"' : '', '>', $txt['mboards_theme_default'], '</option>';
    ...
    echo '
								...
								<td valign="top" align="right">
									<input type="checkbox" name="override_theme"', $context['board']['override_theme'] ? ' checked' : '', ' class="check">
								</td>
							</tr>';
...
<form action="', $scripturl, '?action=manageboards;sa=board2" method="post" accept-charset="', $context['character_set'], '">
	...
	<table width="600" cellpadding="4" cellspacing="0" border="0" align="center" class="tborder">
		...
		<tr>
			<td class="windowbg2">
				<label for="delete_action0"><input type="radio" id="delete_action0" name="delete_action" value="0" class="check" checked>', $txt['mboards_delete_board_option1'], '</label><br>
...
function template_modify_general_settings()
{
    ...
    echo '
			<tr class="windowbg2">
				...
				<td>
					<input type="checkbox" name="countChildPosts" id="countChildPosts_check"', empty($modSettings['countChildPosts']) ? '' : ' checked', ' class="check">
				</td>
			</tr><tr class="windowbg2">
				...
				<td>
					<input type="checkbox" name="recycle_enable" id="recycle_enable_check"', empty($modSettings['recycle_enable']) ? '' : ' checked', ' class="check" onclick="document.getElementById(\'recycle_board_select\').disabled = !this.checked;">
				</td>
			</tr><tr class="windowbg2">
