...
function template_main()
{
    ...
    if ($context['can_moderate_poll']) {
        echo '
								...
								<td align="right"></td>
								<td class="smalltext"><label for="poll_change_vote"><input type="checkbox" id="poll_change_vote" name="poll_change_vote"', !empty($context['poll']['change_vote']) ? ' checked' : '', ' class="check"> ', $txt['poll_options7'], '</label></td>
							</tr><tr>
								<td align="right"></td>';
    } else {
        echo '
    ...
    echo '
								<td class="smalltext">
									<input type="radio" name="poll_hide" value="0"', 0 == $context['poll']['hide_results'] ? ' checked' : '', ' class="check"> ' . $txt['poll_options2'] . '<br>
									<input type="radio" name="poll_hide" value="1"', 1 == $context['poll']['hide_results'] ? ' checked' : '', ' class="check"> ' . $txt['poll_options3'] . '<br>
									<input type="radio" name="poll_hide" value="2"', 2 == $context['poll']['hide_results'] ? ' checked' : '', empty($context['poll']['expiration']) ? 'disabled="disabled"' : '', ' class="check"> ' . $txt['poll_options4'] . '<br>
									<br>
								</td>';
