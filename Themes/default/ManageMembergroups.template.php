...
function template_main()
{
    ...
    foreach ($context['groups']['regular'] as $group) {
        echo '
					<tr>
						<td class="windowbg2">', empty($group['color']) ? ($group['can_search'] ? $group['link'] : $group['name']) : '<span style="color: ' . $group['color'] . '">' . ($group['can_search'] ? $group['link'] : $group['name']) . '</span>', 1 == $group['id'] ? ' (<a href="'
                                                                                                                                                                                                                                                                                 . $scripturl
...
function template_new_group()
{
				...
				<tr class="windowbg2">
					...
					<td>
						<fieldset id="permission_base">
							...
							<input type="radio" name="perm_type" id="perm_type_predefined" value="predefined" checked class="check">
    ...
    foreach ($context['boards'] as $board) {
        echo '
							<div style="margin-left: ', $board['child_level'], 'em;"><input type="checkbox" name="boardaccess[]" id="boardaccess_', $board['id'], '" value="', $board['id'], '" ', $board['selected'] ? ' checked disabled="disabled"' : '', ' class="check"> <label for="boardaccess_', $board['id'], '">', $board['name'], '</label></div>';
    }
...
function template_edit_group()
{
    ...
    if ($context['group']['allow_post_group']) {
        echo '
				<tr class="windowbg2">
					...
					<td><input type="checkbox" name="post_group" id="post_group_check" value="1"', $context['group']['is_post_group'] ? ' checked' : '', ' onclick="swapPostGroup(this.checked);" class="check"></td>
				</tr>
				<tr class="windowbg2">
    ...
    echo '
				...
				<tr class="windowbg2">
					...
					<td>
						<input type="text" name="max_messages" id="max_messages_input" value="', 1 == $context['group']['id'] ? 0 : $context['group']['max_messages'], '" size="6" ', 1 == $context['group']['id'] ? 'disabled="disabled"' : '', '>
					</td>
				</tr>';
    ...
    if (!empty($context['boards'])) {
        ...
        foreach ($context['boards'] as $board) {
            echo '
							<div style="margin-left: ', $board['child_level'], 'em;"><input type="checkbox" name="boardaccess[]" id="boardaccess_', $board['id'], '" value="', $board['id'], '" ', $board['selected'] ? ' checked' : '', ' class="check"> <label for="boardaccess_', $board['id'], '">', $board['name'], '</label></div>';
        }
    ...
    echo '
		<form action="', $scripturl, '?action=membergroups;sa=members;group=', $context['group']['id'], '" method="post" accept-charset="', $context['character_set'], '">
			<table width="90%" cellpadding="4" cellspacing="1" border="0" class="bordercolor" align="center">
				...
				<tr class="titlebg">
					<td><a href="', $scripturl, '?action=membergroups;sa=members;start=', $context['start'], ';sort=name', 'name' == $context['sort_by'] && 'up' == $context['sort_direction'] ? ';desc' : '', ';group=', $context['group']['id'], '">', $txt[68], 'name'
                                                                                                                                                                                                                                                                   == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                               . $settings['images_url']
                                                                                                                                                                                                                                                                               . '/sort_'
                                                                                                                                                                                                                                                                               . $context['sort_direction']
                                                                                                                                                                                                                                                                               . '.gif" alt="">' : '', '</a></td>
					<td><a href="', $scripturl, '?action=membergroups;sa=members;start=', $context['start'], ';sort=email', 'email' == $context['sort_by'] && 'up' == $context['sort_direction'] ? ';desc' : '', ';group=', $context['group']['id'], '">', $txt[69], 'email'
                                                                                                                                                                                                                                                                     == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                                  . $settings['images_url']
                                                                                                                                                                                                                                                                                  . '/sort_'
                                                                                                                                                                                                                                                                                  . $context['sort_direction']
                                                                                                                                                                                                                                                                                  . '.gif" alt="">' : '', '</a></td>
					<td><a href="', $scripturl, '?action=membergroups;sa=members;start=', $context['start'], ';sort=active', 'active' == $context['sort_by']
                                                                                                                             && 'up' == $context['sort_direction'] ? ';desc' : '', ';group=', $context['group']['id'], '">', $txt['attachment_manager_last_active'], 'active'
                                                                                                                                                                                                                                                                     == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                                   . $settings['images_url']
                                                                                                                                                                                                                                                                                   . '/sort_'
                                                                                                                                                                                                                                                                                   . $context['sort_direction']
                                                                                                                                                                                                                                                                                   . '.gif" alt="">' : '', '</a></td>
					<td><a href="', $scripturl, '?action=membergroups;sa=members;start=', $context['start'], ';sort=registered', 'registered' == $context['sort_by'] && 'up' == $context['sort_direction'] ? ';desc' : '', ';group=', $context['group']['id'], '">', $txt[233], 'registered'
                                                                                                                                                                                                                                                                                == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                                                  . $settings['images_url']
                                                                                                                                                                                                                                                                                                  . '/sort_'
                                                                                                                                                                                                                                                                                                  . $context['sort_direction']
                                                                                                                                                                                                                                                                                                  . '.gif" alt="">' : '', '</a></td>
					<td', empty($context['group']['assignable']) ? ' colspan="2"' : '', '><a href="', $scripturl, '?action=membergroups;sa=members;start=', $context['start'], ';sort=posts', 'posts' == $context['sort_by']
                                                                                                                                                                                              && 'up'
                                                                                                                                                                                                 == $context['sort_direction'] ? ';desc' : '', ';group=', $context['group']['id'], '">', $txt[21], 'posts'
                                                                                                                                                                                                                                                                             == $context['sort_by'] ? ' <img src="'
                                                                                                                                                                                                                                                                                          . $settings['images_url']
                                                                                                                                                                                                                                                                                          . '/sort_'
                                                                                                                                                                                                                                                                                          . $context['sort_direction']
