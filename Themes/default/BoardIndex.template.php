...
function template_main()
{
		...
		<table border="0" width="100%" cellspacing="1" cellpadding="5" class="bordercolor" style="margin-top: 1px;">';
			...
			<tr>
                ...
                if (!empty($board['moderators'])) {
                    echo '
					<div style="padding-top: 1px;" class="smalltext"><i>', 1 == count($board['moderators']) ? $txt[298] : $txt[299], ': ', implode(', ', $board['link_moderators']), '</i></div>';
                }
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="5">
        ...
        $mark_read_button = ['markread' => ['text' => 452, 'image' => 'markread.gif', 'lang' => true, 'url' => $scripturl . '?action=markasread;sa=all;sesc=' . $context['session_id']]];
    ...
    if (!empty($settings['number_recent_posts'])) {
        ...
        if (1 == $settings['number_recent_posts']) {
    ...
    if ($context['show_calendar']) {
        ...
        if (!empty($context['calendar_events'])) {
            ...
            foreach ($context['calendar_events'] as $event) {
                echo '
							', $event['can_edit'] ? '<a href="' . $event['modify_href'] . '" style="color: #FF0000;">*</a> ' : '', '' == $event['href'] ? '' : '<a href="' . $event['href'] . '">', $event['is_today'] ? '<b>' . $event['title'] . '</b>' : $event['title'], ''
                                                                                                                                                                                                                                                                             == $event['href'] ? '' : '</a>', $event['is_last'] ? '<br>' : ', ';
            }
    ...
    echo '
						', $context['show_who'] ? '<a href="' . $scripturl . '?action=who">' : '', (empty($context['spiders']) ? '' : $context['num_spiders']
                                                                                                                                      . ' '
                                                                                                                                      . (1 == $context['num_spiders'] ? $txt['ob_googlebot_spider'] : $txt['ob_googlebot_spiders'])
                                                                                                                                      . ', '), $context['num_guests'], ' ', 1 == $context['num_guests'] ? $txt['guest'] : $txt['guests'], ', '
                                                                                                                                                                                                                                          . $context['num_users_online'], ' ', 1
                                                                                                                                                                                                                                                                               == $context['num_users_online'] ? $txt['user'] : $txt['users'];
    ...
    if (!empty($context['num_users_hidden']) || ($context['show_buddies'] && !empty($context['show_buddies']))) {
        ...
        if ($context['show_buddies']) {
            echo $context['num_buddies'], ' ', 1 == $context['num_buddies'] ? $txt['buddy'] : $txt['buddies'];
        }
        ...
        echo '
				<tr>
					...
					<td class="windowbg2" valign="top">
						...
						<div class="smalltext">
							', $txt[660], ' ', $context['user']['messages'], ' ', 1 == $context['user']['messages'] ? $txt[471] : $txt[153], '.... ', $txt[661], ' <a href="', $scripturl, '?action=pm">', $txt[662], '</a> ', $txt[663], '
						</div>
					</td>
				</tr>';
    }
						...
						<form action="', $scripturl, '?action=login2" method="post" accept-charset="', $context['character_set'], '" style="margin: 0;">
							<table border="0" cellpadding="2" cellspacing="0" align="center" width="100%"><tr>
								...
								<td valign="middle" align="left">
									...
									<input type="checkbox" name="cookieneverexp" id="cookieneverexp" checked class="check"></label>
								</td>
								<td valign="middle" align="left">
